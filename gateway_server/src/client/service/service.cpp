...
void ClientReceiver::OnConnection(const muduo::net::TcpConnectionPtr& conn)
{
    if (!conn->connected())
    {
        ...
        LoginRpcClient::GetSingleton()->CallMethod(&ClientReceiver::OnDisconnectReplied,
            p,
            this,
    ...
    muduo::Timestamp)
{
    ...
    p->s_rqst_.set_connection_id(p->connection_hash_id());
    LoginRpcClient::GetSingleton()->CallMethod(&ClientReceiver::OnServerLoginReplied,
        p, 
        this, 
                                    ...
                                    muduo::Timestamp)
{
    ...
    p->s_rqst_.set_connection_id(p->connection_hash_id());
    LoginRpcClient::GetSingleton()->CallMethod(&ClientReceiver::OnServerCreatePlayerReplied,
        p, 
        this, 
                                ...
                                muduo::Timestamp)
{
    ...
    LoginRpcClient::GetSingleton()->CallMethod(&ClientReceiver::OnServerEnterGameReplied,
        p,
        this,
