#ifndef MASTER_SERVER_SRC_SERVICE_LOGIC_TEAM_NORMAL_H_
#define MASTER_SERVER_SRC_SERVICE_LOGIC_TEAM_NORMAL_H_
...
#endif//MASTER_SERVER_SRC_SERVICE_LOGIC_TEAM_NORMAL_H_
