...
namespace behaviac
{
	...
	public:
		...
		virtual bool load()
		{
			AgentMeta::SetTotalSignature(1594408204u);
			...
			// ClientAI
			meta = BEHAVIAC_NEW AgentMeta(1278083825u);
			AgentMeta::GetAgentMetas()[2749207510u] = meta;
			meta->RegisterMethod(1045109914u, BEHAVIAC_NEW CAgentStaticMethodVoid_1<char*>(FunctionPointer_ClientAI_LogMessage));
			meta->RegisterMethod(3836292229u, BEHAVIAC_NEW CAgentMethodVoid(FunctionPointer_ClientAI_ReadyGo));
			meta->RegisterMethod(2521019022u, BEHAVIAC_NEW CMethod_behaviac_Agent_VectorAdd());
			meta->RegisterMethod(2306090221u, BEHAVIAC_NEW CMethod_behaviac_Agent_VectorClear());
			meta->RegisterMethod(3483755530u, BEHAVIAC_NEW CMethod_behaviac_Agent_VectorContains());
			meta->RegisterMethod(505785840u, BEHAVIAC_NEW CMethod_behaviac_Agent_VectorLength());
			...
			AgentMeta::Register<ClientAI>("ClientAI");
		...
		virtual bool unLoad()
		{
			...
			AgentMeta::UnRegister<ClientAI>("ClientAI");
