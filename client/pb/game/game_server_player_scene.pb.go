...
// 	protoc        v5.26.1
// source: logic/server_player/game_server_player_scene.proto
...
func (x *GsEnterSceneRequest) Reset() {
	*x = GsEnterSceneRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_logic_server_player_game_server_player_scene_proto_msgTypes[0]
...
func (*GsEnterSceneRequest) Descriptor() ([]byte, []int) {
	return file_logic_server_player_game_server_player_scene_proto_rawDescGZIP(), []int{0}
}
...
func (x *GsLeaveSceneRequest) Reset() {
	*x = GsLeaveSceneRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_logic_server_player_game_server_player_scene_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*GsLeaveSceneRequest) Descriptor() ([]byte, []int) {
	return file_logic_server_player_game_server_player_scene_proto_rawDescGZIP(), []int{1}
}
...
func (x *EnterSceneS2CRequest) Reset() {
	*x = EnterSceneS2CRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_logic_server_player_game_server_player_scene_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*EnterSceneS2CRequest) Descriptor() ([]byte, []int) {
	return file_logic_server_player_game_server_player_scene_proto_rawDescGZIP(), []int{2}
}
...
func (x *EnterScenerS2CResponse) Reset() {
	*x = EnterScenerS2CResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_logic_server_player_game_server_player_scene_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*EnterScenerS2CResponse) Descriptor() ([]byte, []int) {
	return file_logic_server_player_game_server_player_scene_proto_rawDescGZIP(), []int{3}
}
...
var File_logic_server_player_game_server_player_scene_proto protoreflect.FileDescriptor

var file_logic_server_player_game_server_player_scene_proto_rawDesc = []byte{
	0x0a, 0x32, 0x6c, 0x6f, 0x67, 0x69, 0x63, 0x2f, 0x73, 0x65, 0x72, 0x76, 0x65, 0x72, 0x5f, 0x70,
	0x6c, 0x61, 0x79, 0x65, 0x72, 0x2f, 0x67, 0x61, 0x6d, 0x65, 0x5f, 0x73, 0x65, 0x72, 0x76, 0x65,
	0x72, 0x5f, 0x70, 0x6c, 0x61, 0x79, 0x65, 0x72, 0x5f, 0x73, 0x63, 0x65, 0x6e, 0x65, 0x2e, 0x70,
...
var (
	file_logic_server_player_game_server_player_scene_proto_rawDescOnce sync.Once
	file_logic_server_player_game_server_player_scene_proto_rawDescData = file_logic_server_player_game_server_player_scene_proto_rawDesc
)

func file_logic_server_player_game_server_player_scene_proto_rawDescGZIP() []byte {
	file_logic_server_player_game_server_player_scene_proto_rawDescOnce.Do(func() {
		file_logic_server_player_game_server_player_scene_proto_rawDescData = protoimpl.X.CompressGZIP(file_logic_server_player_game_server_player_scene_proto_rawDescData)
	})
	return file_logic_server_player_game_server_player_scene_proto_rawDescData
}

var file_logic_server_player_game_server_player_scene_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_logic_server_player_game_server_player_scene_proto_goTypes = []any{
...
var file_logic_server_player_game_server_player_scene_proto_depIdxs = []int32{
...
func init() { file_logic_server_player_game_server_player_scene_proto_init() }
func file_logic_server_player_game_server_player_scene_proto_init() {
	if File_logic_server_player_game_server_player_scene_proto != nil {
		return
	}
	file_common_tip_proto_init()
	file_logic_component_scene_comp_proto_init()
	if !protoimpl.UnsafeEnabled {
		file_logic_server_player_game_server_player_scene_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_logic_server_player_game_server_player_scene_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_logic_server_player_game_server_player_scene_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_logic_server_player_game_server_player_scene_proto_msgTypes[3].Exporter = func(v any, i int) any {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_logic_server_player_game_server_player_scene_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_logic_server_player_game_server_player_scene_proto_goTypes,
		DependencyIndexes: file_logic_server_player_game_server_player_scene_proto_depIdxs,
		MessageInfos:      file_logic_server_player_game_server_player_scene_proto_msgTypes,
	}.Build()
	File_logic_server_player_game_server_player_scene_proto = out.File
	file_logic_server_player_game_server_player_scene_proto_rawDesc = nil
	file_logic_server_player_game_server_player_scene_proto_goTypes = nil
	file_logic_server_player_game_server_player_scene_proto_depIdxs = nil
}
