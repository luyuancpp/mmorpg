...
if not os.path.exists("json"):
	os.makedirs("json")
if not os.path.exists("../../pkg/config/src/game_config/"):
	os.makedirs("../../pkg/config/src/game_config/")
...
print(system("python md5tool.py md5copy ./protocpp/ ../../pkg/config/src/game_config/ "))
