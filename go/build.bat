...
goctl rpc protoc ../proto/db/db.proto --proto_path=../ --proto_path=../third_party/protobuf/src/ --go_out=./generated/pb/game --go-grpc_out=./generated/pb/game --zrpc_out=./db -m
goctl rpc protoc ../proto/login/login.proto --proto_path=../ --proto_path=../third_party/grpc/third_party/protobuf/src/ --go_out=./ --go-grpc_out=./ --zrpc_out=./login -m
