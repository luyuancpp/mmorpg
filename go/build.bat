...
goctl rpc protoc ../generated/generated_proto/login/go-zero_proto/service/go/grpc/login/login.proto --proto_path=../generated/generated_proto/login --go_out=./login --go-grpc_out=./login --zrpc_out=./login -m
