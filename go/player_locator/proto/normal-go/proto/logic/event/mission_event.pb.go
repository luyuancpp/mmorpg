...
const file_proto_logic_event_mission_event_proto_rawDesc = "" +
	"\n" +
	"%proto/logic/event/mission_event.proto\"K\n" +
	...
	"\x06entity\x18\x01 \x01(\x04R\x06entity\x12\x1d\n" +
	"\n" +
	"mission_id\x18\x02 \x01(\rR\tmissionIdB8Z6player_locator/proto/normal-go/proto/logic/event;eventb\x06proto3"

var (
	file_proto_logic_event_mission_event_proto_rawDescOnce sync.Once
	file_proto_logic_event_mission_event_proto_rawDescData []byte
)
...
func file_proto_logic_event_mission_event_proto_rawDescGZIP() []byte {
	file_proto_logic_event_mission_event_proto_rawDescOnce.Do(func() {
		file_proto_logic_event_mission_event_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_proto_logic_event_mission_event_proto_rawDesc), len(file_proto_logic_event_mission_event_proto_rawDesc)))
	})
...
func file_proto_logic_event_mission_event_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_proto_logic_event_mission_event_proto_rawDesc), len(file_proto_logic_event_mission_event_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   0,
