...
import (
	...
	component "player_locator/proto/normal-go/proto/logic/component"
	reflect "reflect"
	sync "sync"
	unsafe "unsafe"
)
...
func (x *ReleaseSkillSkillRequest) Reset() {
	*x = ReleaseSkillSkillRequest{}
	mi := &file_proto_service_cpp_rpc_scene_player_skill_proto_msgTypes[0]
...
func (*ReleaseSkillSkillRequest) Descriptor() ([]byte, []int) {
	return file_proto_service_cpp_rpc_scene_player_skill_proto_rawDescGZIP(), []int{0}
}
...
func (x *ReleaseSkillSkillResponse) Reset() {
	*x = ReleaseSkillSkillResponse{}
	mi := &file_proto_service_cpp_rpc_scene_player_skill_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (x *SkillInterruptedS2C) Reset() {
	*x = SkillInterruptedS2C{}
	mi := &file_proto_service_cpp_rpc_scene_player_skill_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*SkillInterruptedS2C) Descriptor() ([]byte, []int) {
	return file_proto_service_cpp_rpc_scene_player_skill_proto_rawDescGZIP(), []int{2}
}
...
func (x *SkillUsedS2C) Reset() {
	*x = SkillUsedS2C{}
	mi := &file_proto_service_cpp_rpc_scene_player_skill_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*SkillUsedS2C) Descriptor() ([]byte, []int) {
	return file_proto_service_cpp_rpc_scene_player_skill_proto_rawDescGZIP(), []int{3}
}
...
func (x *GetSkillListRequest) Reset() {
	*x = GetSkillListRequest{}
	mi := &file_proto_service_cpp_rpc_scene_player_skill_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GetSkillListRequest) Descriptor() ([]byte, []int) {
	return file_proto_service_cpp_rpc_scene_player_skill_proto_rawDescGZIP(), []int{4}
}
...
func (x *GetSkillListResponse) Reset() {
	*x = GetSkillListResponse{}
	mi := &file_proto_service_cpp_rpc_scene_player_skill_proto_msgTypes[5]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
var File_proto_service_cpp_rpc_scene_player_skill_proto protoreflect.FileDescriptor

const file_proto_service_cpp_rpc_scene_player_skill_proto_rawDesc = "" +
	"\n" +
	".proto/service/cpp/rpc/scene/player_skill.proto\x1a+proto/service/go/grpc/db/proto_option.proto\x1a\x16proto/common/tip.proto\x1a proto/logic/component/comp.proto\x1a\x18proto/common/empty.proto\x1a-proto/logic/component/player_skill_comp.proto\x1a&proto/logic/component/actor_comp.proto\"\xaa\x01\n" +
	...
	"\x80\xa8\xc3\x01\x01\x88\xa8\xc3\x01\x01BI\x98\xd4a\x03Z@player_locator/proto/normal-go/proto/service/cpp/rpc/scene;scene\x80\x01\x01b\x06proto3"

var (
	file_proto_service_cpp_rpc_scene_player_skill_proto_rawDescOnce sync.Once
	file_proto_service_cpp_rpc_scene_player_skill_proto_rawDescData []byte
)

func file_proto_service_cpp_rpc_scene_player_skill_proto_rawDescGZIP() []byte {
	file_proto_service_cpp_rpc_scene_player_skill_proto_rawDescOnce.Do(func() {
		file_proto_service_cpp_rpc_scene_player_skill_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_proto_service_cpp_rpc_scene_player_skill_proto_rawDesc), len(file_proto_service_cpp_rpc_scene_player_skill_proto_rawDesc)))
	})
	return file_proto_service_cpp_rpc_scene_player_skill_proto_rawDescData
}
...
func init() { file_proto_service_cpp_rpc_scene_player_skill_proto_init() }
func file_proto_service_cpp_rpc_scene_player_skill_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_proto_service_cpp_rpc_scene_player_skill_proto_rawDesc), len(file_proto_service_cpp_rpc_scene_player_skill_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   6,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_proto_service_cpp_rpc_scene_player_skill_proto_goTypes,
		DependencyIndexes: file_proto_service_cpp_rpc_scene_player_skill_proto_depIdxs,
		MessageInfos:      file_proto_service_cpp_rpc_scene_player_skill_proto_msgTypes,
	}.Build()
	File_proto_service_cpp_rpc_scene_player_skill_proto = out.File
	file_proto_service_cpp_rpc_scene_player_skill_proto_goTypes = nil
	file_proto_service_cpp_rpc_scene_player_skill_proto_depIdxs = nil
}
