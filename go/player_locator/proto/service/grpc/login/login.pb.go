...
func (x *LoginEmptyResponse) Reset() {
	*x = LoginEmptyResponse{}
	mi := &file_proto_service_grpc_login_login_proto_msgTypes[11]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*LoginEmptyResponse) Descriptor() ([]byte, []int) {
	return file_proto_service_grpc_login_login_proto_rawDescGZIP(), []int{11}
}
...
const file_proto_service_grpc_login_login_proto_rawDesc = "" +
	"\n" +
	"$proto/service/grpc/login/login.proto\x12\aloginpb\x1a(proto/service/grpc/db/proto_option.proto\x1a\x16proto/common/tip.proto\x1a proto/common/user_accounts.proto\"\xcb\x01\n" +
	...
	"\n" +
	"Disconnect\x12#.loginpb.LoginNodeDisconnectRequest\x1a\x1b.loginpb.LoginEmptyResponse\x1a\x05\x88\xa8\xc3\x01\x01B/Z-player_locator/proto/service/grpc/login;loginb\x06proto3"
...
var file_proto_service_grpc_login_login_proto_msgTypes = make([]protoimpl.MessageInfo, 12)
