...
func (x *BindSessionToGateResponse) Reset() {
	*x = BindSessionToGateResponse{}
	mi := &file_proto_service_rpc_gate_gate_service_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*BindSessionToGateResponse) Descriptor() ([]byte, []int) {
	return file_proto_service_rpc_gate_gate_service_proto_rawDescGZIP(), []int{2}
}
...
func (x *BroadcastToPlayersRequest) Reset() {
	*x = BroadcastToPlayersRequest{}
	mi := &file_proto_service_rpc_gate_gate_service_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*BroadcastToPlayersRequest) Descriptor() ([]byte, []int) {
	return file_proto_service_rpc_gate_gate_service_proto_rawDescGZIP(), []int{3}
}
...
const file_proto_service_rpc_gate_gate_service_proto_rawDesc = "" +
	"\n" +
	")proto/service/rpc/gate/gate_service.proto\x1a(proto/service/grpc/db/proto_option.proto\x1a\x18proto/common/empty.proto\x1a\x1aproto/common/message.proto\"m\n" +
	...
	"\x11BindSessionToGate\x12\x19.BindSessionToGateRequest\x1a\x1a.BindSessionToGateResponseB3\x98\xd4a\x02Z*player_locator/proto/service/rpc/gate;gate\x80\x01\x01b\x06proto3"
...
var file_proto_service_rpc_gate_gate_service_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
