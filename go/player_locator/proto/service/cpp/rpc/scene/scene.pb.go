...
func (x *CreateSceneResponse) GetSceneInfo() *common.SceneInfoComp {
	if x != nil {
		return x.SceneInfo
	}
	return nil
...
const file_proto_service_cpp_rpc_scene_scene_proto_rawDesc = "" +
	...
	"\n" +
	"scene_info\x18\x01 \x01(\v2\x14.SceneInfoCompR\tsceneInfo2\x84\x06\n" +
	"\x05Scene\x12:\n" +
	...
	"\rNodeHandshake\x12\x15.NodeHandshakeRequest\x1a\x16.NodeHandshakeResponseB9\x98\xd4a\x03Z0player_locator/proto/service/cpp/rpc/scene;scene\x80\x01\x01b\x06proto3"
...
var file_proto_service_cpp_rpc_scene_scene_proto_goTypes = []any{
	...
	(*common.SceneInfoComp)(nil),         // 11: SceneInfoComp
