...
const file_proto_logic_component_actor_combat_state_comp_proto_rawDesc = "" +
	...
	"\x1dCombatStateDetailsComp\x12E\n" +
	...
	" CombatStateCollectionComp\x12E\n" +
	"\x06states\x18\x01 \x03(\v2-.CombatStateCollectionComp.StatesEntryR\x06states\x1aY\n" +
	"\vStatesEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\rR\x03key\x124\n" +
	"\x05value\x18\x02 \x01(\v2\x1e.CombatStateDetailsCompR\x05value:\x028\x01*\x1c\n" +
	"\feCombatState\x12\f\n" +
	"\bkSilence\x10\x00B6Z4player_locator/proto/proto/logic/component;componentb\x06proto3"

var (
	file_proto_logic_component_actor_combat_state_comp_proto_rawDescOnce sync.Once
	file_proto_logic_component_actor_combat_state_comp_proto_rawDescData []byte
)
...
func file_proto_logic_component_actor_combat_state_comp_proto_rawDescGZIP() []byte {
	file_proto_logic_component_actor_combat_state_comp_proto_rawDescOnce.Do(func() {
		file_proto_logic_component_actor_combat_state_comp_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_proto_logic_component_actor_combat_state_comp_proto_rawDesc), len(file_proto_logic_component_actor_combat_state_comp_proto_rawDesc)))
	})
...
func file_proto_logic_component_actor_combat_state_comp_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_proto_logic_component_actor_combat_state_comp_proto_rawDesc), len(file_proto_logic_component_actor_combat_state_comp_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   0,
