...
const file_proto_login_login_proto_rawDesc = "" +
	...
	"\n" +
	"LoginAdmin\x12r\n" +
	"\x19RemovePlayersFromAccounts\x12).loginpb.RemovePlayersFromAccountsRequest\x1a*.loginpb.RemovePlayersFromAccountsResponseB\x13Z\x11guild/proto/loginb\x06proto3"
