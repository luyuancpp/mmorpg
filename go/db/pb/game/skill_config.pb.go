...
const file_skill_config_proto_rawDesc = "" +
	"\n" +
	"\x12skill_config.proto\"o\n" +
...
var (
	...
	file_skill_config_proto_rawDescData []byte
)

func file_skill_config_proto_rawDescGZIP() []byte {
	file_skill_config_proto_rawDescOnce.Do(func() {
		file_skill_config_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_skill_config_proto_rawDesc), len(file_skill_config_proto_rawDesc)))
	})
...
func file_skill_config_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_skill_config_proto_rawDesc), len(file_skill_config_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   5,
			NumExtensions: 0,
			NumServices:   0,
