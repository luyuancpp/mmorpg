...
const file_testmultikey_config_proto_rawDesc = "" +
	"\n" +
	"\x19testmultikey_config.proto\"L\n" +
	...
	"\x16TestMultiKeyTabledData\x12&\n" +
	"\x04data\x18\x01 \x03(\v2\x12.TestMultiKeyTableR\x04dataB\tZ\apb/gameb\x06proto3"

var (
	file_testmultikey_config_proto_rawDescOnce sync.Once
	file_testmultikey_config_proto_rawDescData []byte
)

func file_testmultikey_config_proto_rawDescGZIP() []byte {
	file_testmultikey_config_proto_rawDescOnce.Do(func() {
		file_testmultikey_config_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_testmultikey_config_proto_rawDesc), len(file_testmultikey_config_proto_rawDesc)))
	})
...
func file_testmultikey_config_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_testmultikey_config_proto_rawDesc), len(file_testmultikey_config_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   7,
			NumExtensions: 0,
			NumServices:   0,
