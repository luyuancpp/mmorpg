...
const file_buff_config_proto_rawDesc = "" +
	"\n" +
	"\x11buff_config.proto\"\x88\b\n" +
	"\tBuffTable\x12\x0e\n" +
...
var (
	...
	file_buff_config_proto_rawDescData []byte
)

func file_buff_config_proto_rawDescGZIP() []byte {
	file_buff_config_proto_rawDescOnce.Do(func() {
		file_buff_config_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_buff_config_proto_rawDesc), len(file_buff_config_proto_rawDesc)))
	})
...
func file_buff_config_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_buff_config_proto_rawDesc), len(file_buff_config_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   5,
			NumExtensions: 0,
			NumServices:   0,
