...
const file_tip_login_error_tip_proto_rawDesc = "" +
	"\n" +
	"\x19tip/login_error_tip.proto*\x8c\a\n" +
...
var (
	...
	file_tip_login_error_tip_proto_rawDescData []byte
)

func file_tip_login_error_tip_proto_rawDescGZIP() []byte {
	file_tip_login_error_tip_proto_rawDescOnce.Do(func() {
		file_tip_login_error_tip_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_tip_login_error_tip_proto_rawDesc), len(file_tip_login_error_tip_proto_rawDesc)))
	})
...
func file_tip_login_error_tip_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_tip_login_error_tip_proto_rawDesc), len(file_tip_login_error_tip_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   0,
			NumExtensions: 0,
			NumServices:   0,
