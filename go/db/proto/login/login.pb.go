...
const file_proto_login_login_proto_rawDesc = "" +
	...
	"\n" +
	"LoginAdmin\x12r\n" +
	"\x19RemovePlayersFromAccounts\x12).loginpb.RemovePlayersFromAccountsRequest\x1a*.loginpb.RemovePlayersFromAccountsResponseB\x10Z\x0edb/proto/loginb\x06proto3"
