...
func (UnimplementedCentreServer) LoginNodeSessionDisconnect(context.Context, *base.GateSessionDisconnectRequest) (*base.Empty, error) {
	return nil, status.Error(codes.Unimplemented, "method LoginNodeSessionDisconnect not implemented")
}
func (UnimplementedCentreServer) PlayerService(context.Context, *base.NodeRouteMessageRequest) (*base.NodeRouteMessageResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method PlayerService not implemented")
}
func (UnimplementedCentreServer) EnterGsSucceed(context.Context, *EnterGameNodeSuccessRequest) (*base.Empty, error) {
	return nil, status.Error(codes.Unimplemented, "method EnterGsSucceed not implemented")
}
...
func (UnimplementedCentreServer) InitSceneNode(context.Context, *InitSceneNodeRequest) (*base.Empty, error) {
	return nil, status.Error(codes.Unimplemented, "method InitSceneNode not implemented")
}
...
func RegisterCentreServer(s grpc.ServiceRegistrar, srv CentreServer) {
	// If the following call panics, it indicates UnimplementedCentreServer was
...
var Centre_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "proto/centre/centre_service.proto",
}
