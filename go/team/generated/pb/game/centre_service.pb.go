...
type LoginNodeLeaveGameRequest struct {
	state         protoimpl.MessageState  `protogen:"open.v1"`
	SessionInfo   *common1.SessionDetails `protobuf:"bytes,1,opt,name=session_info,json=sessionInfo,proto3" json:"session_info,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *LoginNodeLeaveGameRequest) GetSessionInfo() *common1.SessionDetails {
	if x != nil {
...
type CentrePlayerGameNodeEntryRequest struct {
	...
	SessionInfo   *common1.SessionDetails `protobuf:"bytes,2,opt,name=session_info,json=sessionInfo,proto3" json:"session_info,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *CentrePlayerGameNodeEntryRequest) GetSessionInfo() *common1.SessionDetails {
	if x != nil {
		return x.SessionInfo
	}
	return nil
...
func (x *CentreLoginResponse) GetErrorMessage() *common1.TipInfoMessage {
	if x != nil {
...
var file_proto_service_cpp_rpc_centre_centre_service_proto_goTypes = []any{
	...
	(*common1.SessionDetails)(nil),               // 9: SessionDetails
	(*common1.TipInfoMessage)(nil),               // 10: TipInfoMessage
	(*common1.GateSessionDisconnectRequest)(nil), // 11: GateSessionDisconnectRequest
	(*common1.NodeRouteMessageRequest)(nil),      // 12: NodeRouteMessageRequest
	(*common1.RouteMessageRequest)(nil),          // 13: RouteMessageRequest
	(*common1.RoutePlayerMessageRequest)(nil),    // 14: RoutePlayerMessageRequest
	(*common1.NodeHandshakeRequest)(nil),         // 15: NodeHandshakeRequest
	(*common1.Empty)(nil),                        // 16: Empty
	(*common1.NodeRouteMessageResponse)(nil),     // 17: NodeRouteMessageResponse
	(*common1.RouteMessageResponse)(nil),         // 18: RouteMessageResponse
	(*common1.RoutePlayerMessageResponse)(nil),   // 19: RoutePlayerMessageResponse
	(*common1.NodeHandshakeResponse)(nil),        // 20: NodeHandshakeResponse
}
