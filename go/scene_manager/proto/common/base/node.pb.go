...
const (
	...
	ENodeType_TurnBasedBattleNodeService  ENodeType = 30 // Turn-based battle service (C++)
	ENodeType_TurnBasedDungeonNodeService ENodeType = 31 // Turn-based dungeon/PvE service (C++)
)
...
var (
	ENodeType_name = map[int32]string{
		...
		30: "TurnBasedBattleNodeService",
		31: "TurnBasedDungeonNodeService",
	}
	ENodeType_value = map[string]int32{
		...
		"TurnBasedBattleNodeService":  30,
		"TurnBasedDungeonNodeService": 31,
	}
)
...
const file_proto_common_base_node_proto_rawDesc = "" +
	"\n" +
	"\x1cproto/common/base/node.proto\x12\vcommon.base*\xd4\x05\n" +
	"\teNodeType\x12\x16\n" +
	...
	"\x14SlgBattleNodeService\x10\x1d\x12\x1e\n" +
	"\x1aTurnBasedBattleNodeService\x10\x1e\x12\x1f\n" +
	"\x1bTurnBasedDungeonNodeService\x10\x1f*g\n" +
	...
	"\rPROTOCOL_HTTP\x10\x02B!Z\x1fscene_manager/proto/common/baseb\x06proto3"
