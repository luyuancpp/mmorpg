...
type PlayerMigrationPbEvent struct {
	...
	SceneInfo            *component.ChangeSceneInfoPBComponent `protobuf:"bytes,9,opt,name=scene_info,json=sceneInfo,proto3" json:"scene_info,omitempty"`
...
func (x *PlayerMigrationPbEvent) GetSceneInfo() *component.ChangeSceneInfoPBComponent {
	if x != nil {
		return x.SceneInfo
	}
	return nil
...
const file_proto_common_event_player_migration_event_proto_rawDesc = "" +
	"\n" +
	"/proto/common/event/player_migration_event.proto\x1a'proto/common/component/scene_comp.proto\"\xf1\x02\n" +
	...
	"\n" +
	"scene_info\x18\t \x01(\v2\x1b.ChangeSceneInfoPBComponentR\tsceneInfoB(Z&scene_manager/proto/common/event;eventb\x06proto3"
...
var file_proto_common_event_player_migration_event_proto_goTypes = []any{
	...
	(*component.ChangeSceneInfoPBComponent)(nil), // 1: ChangeSceneInfoPBComponent
}
