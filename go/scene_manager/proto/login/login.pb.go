...
const file_proto_login_login_proto_rawDesc = "" +
	...
	"\n" +
	"LoginAdmin\x12r\n" +
	"\x19RemovePlayersFromAccounts\x12).loginpb.RemovePlayersFromAccountsRequest\x1a*.loginpb.RemovePlayersFromAccountsResponseB\x1bZ\x19scene_manager/proto/loginb\x06proto3"
