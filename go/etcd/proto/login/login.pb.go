...
const file_proto_login_login_proto_rawDesc = "" +
	...
	"\n" +
	"LoginAdmin\x12r\n" +
	"\x19RemovePlayersFromAccounts\x12).loginpb.RemovePlayersFromAccountsRequest\x1a*.loginpb.RemovePlayersFromAccountsResponseB\x12Z\x10etcd/proto/loginb\x06proto3"
