...
const file_reward_config_proto_rawDesc = "" +
	"\n" +
	"\x13reward_config.proto\"R\n" +
...
var (
	...
	file_reward_config_proto_rawDescData []byte
)

func file_reward_config_proto_rawDescGZIP() []byte {
	file_reward_config_proto_rawDescOnce.Do(func() {
		file_reward_config_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_reward_config_proto_rawDesc), len(file_reward_config_proto_rawDesc)))
	})
...
func file_reward_config_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_reward_config_proto_rawDesc), len(file_reward_config_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
