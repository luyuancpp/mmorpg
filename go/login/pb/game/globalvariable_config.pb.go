...
const file_globalvariable_config_proto_rawDesc = "" +
	"\n" +
	"\x1bglobalvariable_config.proto\"\xad\x01\n" +
...
var (
	...
	file_globalvariable_config_proto_rawDescData []byte
)

func file_globalvariable_config_proto_rawDescGZIP() []byte {
	file_globalvariable_config_proto_rawDescOnce.Do(func() {
		file_globalvariable_config_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_globalvariable_config_proto_rawDesc), len(file_globalvariable_config_proto_rawDesc)))
	})
...
func file_globalvariable_config_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_globalvariable_config_proto_rawDesc), len(file_globalvariable_config_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
