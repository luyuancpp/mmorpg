...
const file_scene_config_proto_rawDesc = "" +
	"\n" +
	"\x12scene_config.proto\";\n" +
	"\n" +
	"SceneTable\x12\x0e\n" +
...
var (
	...
	file_scene_config_proto_rawDescData []byte
)

func file_scene_config_proto_rawDescGZIP() []byte {
	file_scene_config_proto_rawDescOnce.Do(func() {
		file_scene_config_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_scene_config_proto_rawDesc), len(file_scene_config_proto_rawDesc)))
	})
...
func file_scene_config_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_scene_config_proto_rawDesc), len(file_scene_config_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
