...
func (UnimplementedCentreSceneServer) RegisterScene(context.Context, *RegisterSceneRequest) (*RegisterSceneResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method RegisterScene not implemented")
}
func (UnimplementedCentreSceneServer) UnRegisterScene(context.Context, *UnRegisterSceneRequest) (*base.Empty, error) {
	return nil, status.Error(codes.Unimplemented, "method UnRegisterScene not implemented")
}
...
func RegisterCentreSceneServer(s grpc.ServiceRegistrar, srv CentreSceneServer) {
	// If the following call panics, it indicates UnimplementedCentreSceneServer was
...
var CentreScene_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "proto/centre/centre_scene.proto",
}
