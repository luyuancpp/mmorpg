...
const file_proto_service_go_grpc_login_login_proto_rawDesc = "" +
	...
	"\n" +
	"Disconnect\x12#.loginpb.LoginNodeDisconnectRequest\x1a\x1b.loginpb.LoginEmptyResponse\x1a\x05\x88\xa8\xc3\x01\x01B)Z'login/proto/service/go/grpc/login;loginb\x06proto3"
