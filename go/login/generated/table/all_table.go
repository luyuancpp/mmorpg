...
// LoadTables loads all config tables (synchronous).
...
// LoadTablesAsync loads all config tables asynchronously using goroutines + WaitGroup.
...
// OnTablesLoadSuccess registers a callback to run after all tables are loaded.
