...
func (s *ClientPlayerLoginServer) LeaveGame(ctx context.Context, in *login_login.LeaveGameRequest) (*login_login.LoginEmptyResponse, error) {
	l := clientplayerloginlogic.NewLeaveGameLogic(ctx, s.svcCtx)
	return l.LeaveGame(in)
}

func (s *ClientPlayerLoginServer) Disconnect(ctx context.Context, in *login_login.LoginNodeDisconnectRequest) (*login_login.LoginEmptyResponse, error) {
