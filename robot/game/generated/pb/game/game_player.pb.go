...
const file_proto_scene_game_player_proto_rawDesc = "" +
	"\n" +
	"\x1dproto/scene/game_player.proto\x1a\x1bgoogle/protobuf/empty.proto\";\n" +
	...
	"\bExitGame\x12\x18.GameNodeExitGameRequest\x1a\x16.google.protobuf.EmptyB\x1bZ\x16game/generated/pb/game\x80\x01\x01b\x06proto3"

var (
	file_proto_scene_game_player_proto_rawDescOnce sync.Once
	file_proto_scene_game_player_proto_rawDescData []byte
)

func file_proto_scene_game_player_proto_rawDescGZIP() []byte {
	file_proto_scene_game_player_proto_rawDescOnce.Do(func() {
		file_proto_scene_game_player_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_proto_scene_game_player_proto_rawDesc), len(file_proto_scene_game_player_proto_rawDesc)))
	})
...
func file_proto_scene_game_player_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_proto_scene_game_player_proto_rawDesc), len(file_proto_scene_game_player_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   1,
