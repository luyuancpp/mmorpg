...
func (x *ReleaseSkillSkillRequest) Reset() {
	*x = ReleaseSkillSkillRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_proto_logic_client_player_player_skill_proto_msgTypes[0]
...
func (*ReleaseSkillSkillRequest) Descriptor() ([]byte, []int) {
	return file_proto_logic_client_player_player_skill_proto_rawDescGZIP(), []int{0}
}
...
func (x *ReleaseSkillSkillResponse) Reset() {
	*x = ReleaseSkillSkillResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_proto_logic_client_player_player_skill_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*ReleaseSkillSkillResponse) Descriptor() ([]byte, []int) {
	return file_proto_logic_client_player_player_skill_proto_rawDescGZIP(), []int{1}
}
...
func (x *SkillInterruptedS2C) Reset() {
	*x = SkillInterruptedS2C{}
	if protoimpl.UnsafeEnabled {
		mi := &file_proto_logic_client_player_player_skill_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*SkillInterruptedS2C) Descriptor() ([]byte, []int) {
	return file_proto_logic_client_player_player_skill_proto_rawDescGZIP(), []int{2}
}
...
func (x *SkillUsedS2C) Reset() {
	*x = SkillUsedS2C{}
	if protoimpl.UnsafeEnabled {
		mi := &file_proto_logic_client_player_player_skill_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*SkillUsedS2C) Descriptor() ([]byte, []int) {
	return file_proto_logic_client_player_player_skill_proto_rawDescGZIP(), []int{3}
}
...
func (x *GetSkillListRequest) Reset() {
	*x = GetSkillListRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_proto_logic_client_player_player_skill_proto_msgTypes[4]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*GetSkillListRequest) Descriptor() ([]byte, []int) {
	return file_proto_logic_client_player_player_skill_proto_rawDescGZIP(), []int{4}
}
...
func (x *GetSkillListResponse) Reset() {
	*x = GetSkillListResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_proto_logic_client_player_player_skill_proto_msgTypes[5]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*GetSkillListResponse) Descriptor() ([]byte, []int) {
	return file_proto_logic_client_player_player_skill_proto_rawDescGZIP(), []int{5}
}
...
var File_proto_logic_client_player_player_skill_proto protoreflect.FileDescriptor

var file_proto_logic_client_player_player_skill_proto_rawDesc = []byte{
	...
	0x65, 0x72, 0x5f, 0x73, 0x6b, 0x69, 0x6c, 0x6c, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x1a, 0x16,
	...
	0x70, 0x74, 0x79, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x1a, 0x2d, 0x70, 0x72, 0x6f, 0x74, 0x6f,
	0x2f, 0x6c, 0x6f, 0x67, 0x69, 0x63, 0x2f, 0x63, 0x6f, 0x6d, 0x70, 0x6f, 0x6e, 0x65, 0x6e, 0x74,
	0x2f, 0x70, 0x6c, 0x61, 0x79, 0x65, 0x72, 0x5f, 0x73, 0x6b, 0x69, 0x6c, 0x6c, 0x5f, 0x63, 0x6f,
	...
	,
	...
	0x61, 0x74, 0x69, 0x6f, 0x6e, 0x22, 0x51, 0x0a, 0x19, 0x52, 0x65, 0x6c, 0x65, 0x61, 0x73, 0x65,
	0x53, 0x6b, 0x69, 0x6c, 0x6c, 0x53, 0x6b, 0x69, 0x6c, 0x6c, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e,
	...
	0x72, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x22, 0xb4, 0x01, 0x0a, 0x13, 0x53, 0x6b, 0x69,
	0x6c, 0x6c, 0x49, 0x6e, 0x74, 0x65, 0x72, 0x72, 0x75, 0x70, 0x74, 0x65, 0x64, 0x53, 0x32, 0x43,
	...
	0x65, 0x74, 0x5f, 0x65, 0x6e, 0x74, 0x69, 0x74, 0x79, 0x18, 0x02, 0x20, 0x01, 0x28, 0x04, 0x52,
	...
	0x65, 0x49, 0x64, 0x12, 0x1f, 0x0a, 0x0b, 0x72, 0x65, 0x61, 0x73, 0x6f, 0x6e, 0x5f, 0x63, 0x6f,
	0x64, 0x65, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x0a, 0x72, 0x65, 0x61, 0x73, 0x6f, 0x6e,
	0x43, 0x6f, 0x64, 0x65, 0x12, 0x19, 0x0a, 0x08, 0x73, 0x6b, 0x69, 0x6c, 0x6c, 0x5f, 0x69, 0x64,
	0x18, 0x05, 0x20, 0x01, 0x28, 0x04, 0x52, 0x07, 0x73, 0x6b, 0x69, 0x6c, 0x6c, 0x49, 0x64, 0x22,
	...
	0x69, 0x6d, 0x65, 0x53, 0x74, 0x61, 0x6d, 0x70, 0x22, 0x15, 0x0a, 0x13, 0x47, 0x65, 0x74, 0x53,
	0x6b, 0x69, 0x6c, 0x6c, 0x4c, 0x69, 0x73, 0x74, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x22,
	0x88, 0x01, 0x0a, 0x14, 0x47, 0x65, 0x74, 0x53, 0x6b, 0x69, 0x6c, 0x6c, 0x4c, 0x69, 0x73, 0x74,
	...
	0x0a, 0x0a, 0x73, 0x6b, 0x69, 0x6c, 0x6c, 0x5f, 0x6c, 0x69, 0x73, 0x74, 0x18, 0x02, 0x20, 0x01,
	...
	0x09, 0x73, 0x6b, 0x69, 0x6c, 0x6c, 0x4c, 0x69, 0x73, 0x74, 0x32, 0xfa, 0x01, 0x0a, 0x12, 0x50,
...
var (
	file_proto_logic_client_player_player_skill_proto_rawDescOnce sync.Once
	file_proto_logic_client_player_player_skill_proto_rawDescData = file_proto_logic_client_player_player_skill_proto_rawDesc
)

func file_proto_logic_client_player_player_skill_proto_rawDescGZIP() []byte {
	file_proto_logic_client_player_player_skill_proto_rawDescOnce.Do(func() {
		file_proto_logic_client_player_player_skill_proto_rawDescData = protoimpl.X.CompressGZIP(file_proto_logic_client_player_player_skill_proto_rawDescData)
	})
	return file_proto_logic_client_player_player_skill_proto_rawDescData
}

var file_proto_logic_client_player_player_skill_proto_msgTypes = make([]protoimpl.MessageInfo, 6)
var file_proto_logic_client_player_player_skill_proto_goTypes = []any{
...
var file_proto_logic_client_player_player_skill_proto_depIdxs = []int32{
...
func init() { file_proto_logic_client_player_player_skill_proto_init() }
func file_proto_logic_client_player_player_skill_proto_init() {
	if File_proto_logic_client_player_player_skill_proto != nil {
		return
	}
	...
	if !protoimpl.UnsafeEnabled {
		file_proto_logic_client_player_player_skill_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_proto_logic_client_player_player_skill_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_proto_logic_client_player_player_skill_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_proto_logic_client_player_player_skill_proto_msgTypes[3].Exporter = func(v any, i int) any {
		...
		file_proto_logic_client_player_player_skill_proto_msgTypes[4].Exporter = func(v any, i int) any {
		...
		file_proto_logic_client_player_player_skill_proto_msgTypes[5].Exporter = func(v any, i int) any {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_proto_logic_client_player_player_skill_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   6,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_proto_logic_client_player_player_skill_proto_goTypes,
		DependencyIndexes: file_proto_logic_client_player_player_skill_proto_depIdxs,
		MessageInfos:      file_proto_logic_client_player_player_skill_proto_msgTypes,
	}.Build()
	File_proto_logic_client_player_player_skill_proto = out.File
	file_proto_logic_client_player_player_skill_proto_rawDesc = nil
	file_proto_logic_client_player_player_skill_proto_goTypes = nil
	file_proto_logic_client_player_player_skill_proto_depIdxs = nil
}
