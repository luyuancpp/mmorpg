...
type GetSkillListResponse struct {
	...
	ErrorMessage *TipInfoMessage        `protobuf:"bytes,1,opt,name=error_message,json=errorMessage,proto3" json:"error_message,omitempty"`
	SkillList    *PlayerSkillListPBComp `protobuf:"bytes,2,opt,name=skill_list,json=skillList,proto3" json:"skill_list,omitempty"`
}
...
func (x *GetSkillListResponse) GetSkillList() *PlayerSkillListPBComp {
	if x != nil {
		return x.SkillList
	}
	return nil
...
var file_logic_client_player_player_skill_proto_rawDesc = []byte{
	...
	0x69, 0x73, 0x74, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x22, 0x83, 0x01, 0x0a, 0x14, 0x47,
	...
	0x6f, 0x72, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x12, 0x35, 0x0a, 0x0a, 0x73, 0x6b, 0x69,
	0x6c, 0x6c, 0x5f, 0x6c, 0x69, 0x73, 0x74, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x16, 0x2e,
...
var file_logic_client_player_player_skill_proto_depIdxs = []int32{
	...
	9,  // 5: GetSkillListResponse.skill_list:type_name -> PlayerSkillListPBComp
