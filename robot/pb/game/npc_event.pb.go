...
var File_logic_event_npc_event_proto protoreflect.FileDescriptor
...
var file_logic_event_npc_event_proto_rawDesc = []byte{
	...
	0x63, 0x5f, 0x65, 0x76, 0x65, 0x6e, 0x74, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x41, 0x0a,
	0x1c, 0x49, 0x6e, 0x69, 0x74, 0x69, 0x61, 0x6c, 0x69, 0x7a, 0x65, 0x4e, 0x70, 0x63, 0x43, 0x6f,
	0x6d, 0x70, 0x6f, 0x6e, 0x65, 0x6e, 0x74, 0x73, 0x45, 0x76, 0x65, 0x6e, 0x74, 0x12, 0x21, 0x0a,
...
var (
	file_logic_event_npc_event_proto_rawDescOnce sync.Once
	file_logic_event_npc_event_proto_rawDescData = file_logic_event_npc_event_proto_rawDesc
)

func file_logic_event_npc_event_proto_rawDescGZIP() []byte {
	file_logic_event_npc_event_proto_rawDescOnce.Do(func() {
		file_logic_event_npc_event_proto_rawDescData = protoimpl.X.CompressGZIP(file_logic_event_npc_event_proto_rawDescData)
	})
	return file_logic_event_npc_event_proto_rawDescData
}
...
func init() { file_logic_event_npc_event_proto_init() }
func file_logic_event_npc_event_proto_init() {
	if File_logic_event_npc_event_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_logic_event_npc_event_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_logic_event_npc_event_proto_goTypes,
		DependencyIndexes: file_logic_event_npc_event_proto_depIdxs,
		MessageInfos:      file_logic_event_npc_event_proto_msgTypes,
	}.Build()
	File_logic_event_npc_event_proto = out.File
	file_logic_event_npc_event_proto_rawDesc = nil
	file_logic_event_npc_event_proto_goTypes = nil
	file_logic_event_npc_event_proto_depIdxs = nil
}
