...
const file_proto_scene_game_player_scene_proto_rawDesc = "" +
	"\n" +
	"#proto/scene/game_player_scene.proto\x1a\x16proto/common/tip.proto\x1a\x1bgoogle/protobuf/empty.proto\x1a&proto/logic/component/scene_comp.proto\"O\n" +
	...
	"\rEnterSceneS2C\x12\x15.EnterSceneS2CRequest\x1a\x17.EnterScenerS2CResponseB\fZ\apb/game\x80\x01\x01b\x06proto3"

var (
	file_proto_scene_game_player_scene_proto_rawDescOnce sync.Once
	file_proto_scene_game_player_scene_proto_rawDescData []byte
)
...
func file_proto_scene_game_player_scene_proto_rawDescGZIP() []byte {
	file_proto_scene_game_player_scene_proto_rawDescOnce.Do(func() {
		file_proto_scene_game_player_scene_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_proto_scene_game_player_scene_proto_rawDesc), len(file_proto_scene_game_player_scene_proto_rawDesc)))
	})
...
func file_proto_scene_game_player_scene_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_proto_scene_game_player_scene_proto_rawDesc), len(file_proto_scene_game_player_scene_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   1,
