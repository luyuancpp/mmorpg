...
type AbilityExecutedEvent struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	AbilityId uint64 `protobuf:"varint,1,opt,name=abilityId,proto3" json:"abilityId,omitempty"`
	CasterId  uint64 `protobuf:"varint,2,opt,name=caster_id,json=casterId,proto3" json:"caster_id,omitempty"`
}

func (x *AbilityExecutedEvent) Reset() {
	*x = AbilityExecutedEvent{}
...
func (x *AbilityExecutedEvent) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*AbilityExecutedEvent) ProtoMessage() {}

func (x *AbilityExecutedEvent) ProtoReflect() protoreflect.Message {
	mi := &file_logic_event_buff_event_proto_msgTypes[0]
...
// Deprecated: Use AbilityExecutedEvent.ProtoReflect.Descriptor instead.
func (*AbilityExecutedEvent) Descriptor() ([]byte, []int) {
	return file_logic_event_buff_event_proto_rawDescGZIP(), []int{0}
}

func (x *AbilityExecutedEvent) GetAbilityId() uint64 {
	if x != nil {
		return x.AbilityId
	}
	return 0
...
func (x *AbilityExecutedEvent) GetCasterId() uint64 {
	if x != nil {
		return x.CasterId
	}
	return 0
...
var file_logic_event_buff_event_proto_rawDesc = []byte{
	...
	0x66, 0x66, 0x5f, 0x65, 0x76, 0x65, 0x6e, 0x74, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x51,
	0x0a, 0x14, 0x41, 0x62, 0x69, 0x6c, 0x69, 0x74, 0x79, 0x45, 0x78, 0x65, 0x63, 0x75, 0x74, 0x65,
	0x64, 0x45, 0x76, 0x65, 0x6e, 0x74, 0x12, 0x1c, 0x0a, 0x09, 0x61, 0x62, 0x69, 0x6c, 0x69, 0x74,
	0x79, 0x49, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x04, 0x52, 0x09, 0x61, 0x62, 0x69, 0x6c, 0x69,
	0x74, 0x79, 0x49, 0x64, 0x12, 0x1b, 0x0a, 0x09, 0x63, 0x61, 0x73, 0x74, 0x65, 0x72, 0x5f, 0x69,
	0x64, 0x18, 0x02, 0x20, 0x01, 0x28, 0x04, 0x52, 0x08, 0x63, 0x61, 0x73, 0x74, 0x65, 0x72, 0x49,
...
var file_logic_event_buff_event_proto_goTypes = []any{
	(*AbilityExecutedEvent)(nil), // 0: AbilityExecutedEvent
}
...
func file_logic_event_buff_event_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_logic_event_buff_event_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*AbilityExecutedEvent); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
