...
const file_proto_login_login_service_proto_rawDesc = "" +
	"\n" +
	"\x1fproto/login/login_service.proto\x12\aloginpb\x1a\x18proto/common/empty.proto\x1a\x1aproto/common/session.proto\x1a\x16proto/common/tip.proto\x1a proto/common/user_accounts.proto\"\xcb\x01\n" +
	...
	"\n" +
	"Disconnect\x12#.loginpb.LoginNodeDisconnectRequest\x1a\x06.EmptyB\tZ\apb/gameb\x06proto3"

var (
	file_proto_login_login_service_proto_rawDescOnce sync.Once
	file_proto_login_login_service_proto_rawDescData []byte
)

func file_proto_login_login_service_proto_rawDescGZIP() []byte {
	file_proto_login_login_service_proto_rawDescOnce.Do(func() {
		file_proto_login_login_service_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_proto_login_login_service_proto_rawDesc), len(file_proto_login_login_service_proto_rawDesc)))
	})
...
func file_proto_login_login_service_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_proto_login_login_service_proto_rawDesc), len(file_proto_login_login_service_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   11,
			NumExtensions: 0,
			NumServices:   1,
