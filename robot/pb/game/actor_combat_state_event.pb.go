...
type SilenceRemovedEvent struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *SilenceRemovedEvent) Reset() {
	*x = SilenceRemovedEvent{}
	if protoimpl.UnsafeEnabled {
...
func (x *SilenceRemovedEvent) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SilenceRemovedEvent) ProtoMessage() {}

func (x *SilenceRemovedEvent) ProtoReflect() protoreflect.Message {
	mi := &file_logic_event_actor_combat_state_event_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SilenceRemovedEvent.ProtoReflect.Descriptor instead.
func (*SilenceRemovedEvent) Descriptor() ([]byte, []int) {
	return file_logic_event_actor_combat_state_event_proto_rawDescGZIP(), []int{1}
}

func (x *SilenceRemovedEvent) GetActorEntity() uint64 {
	if x != nil {
		return x.ActorEntity
	}
	return 0
...
func (x *SilenceRemovedEvent) GetSourceBuffId() uint64 {
	if x != nil {
		return x.SourceBuffId
	}
	return 0
...
var file_logic_event_actor_combat_state_event_proto_rawDesc = []byte{
	...
	0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x42, 0x75, 0x66, 0x66, 0x49, 0x64, 0x22, 0x5e, 0x0a, 0x13,
	0x53, 0x69, 0x6c, 0x65, 0x6e, 0x63, 0x65, 0x52, 0x65, 0x6d, 0x6f, 0x76, 0x65, 0x64, 0x45, 0x76,
	0x65, 0x6e, 0x74, 0x12, 0x21, 0x0a, 0x0c, 0x61, 0x63, 0x74, 0x6f, 0x72, 0x5f, 0x65, 0x6e, 0x74,
	0x69, 0x74, 0x79, 0x18, 0x01, 0x20, 0x01, 0x28, 0x04, 0x52, 0x0b, 0x61, 0x63, 0x74, 0x6f, 0x72,
	0x45, 0x6e, 0x74, 0x69, 0x74, 0x79, 0x12, 0x24, 0x0a, 0x0e, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65,
	0x5f, 0x62, 0x75, 0x66, 0x66, 0x5f, 0x69, 0x64, 0x18, 0x02, 0x20, 0x01, 0x28, 0x04, 0x52, 0x0c,
	0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x42, 0x75, 0x66, 0x66, 0x49, 0x64, 0x42, 0x09, 0x5a, 0x07,
...
var file_logic_event_actor_combat_state_event_proto_goTypes = []any{
	...
	(*SilenceRemovedEvent)(nil), // 1: SilenceRemovedEvent
}
...
func file_logic_event_actor_combat_state_event_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_logic_event_actor_combat_state_event_proto_msgTypes[1].Exporter = func(v any, i int) any {
			switch v := v.(*SilenceRemovedEvent); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
