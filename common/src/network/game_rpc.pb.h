...
#ifndef GOOGLE_PROTOBUF_INCLUDED_game_5frpc_2eproto
#define GOOGLE_PROTOBUF_INCLUDED_game_5frpc_2eproto
...
extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_game_5frpc_2eproto;
namespace muduo {
namespace net {
class RpcMessage;
...
#include <google/protobuf/port_undef.inc>
#endif  // GOOGLE_PROTOBUF_INCLUDED_GOOGLE_PROTOBUF_INCLUDED_game_5frpc_2eproto
