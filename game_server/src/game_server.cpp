...
void GameServer::InitNetwork()
{
    ...
    deploy_session_->subscribe<OnClientConnectEvent>(*this);
...
void GameServer::receive(const OnClientConnectEvent& es)
{
...
void GameServer::ConnectMaster()
{
    for (auto e : reg.view<MasterSessionPtr>())
    {
        ...
        master_rpc_client->subscribe<OnClientConnectEvent>(*this);
...
void GameServer::ConnectRegion()
{
    ...
    region_session_->subscribe<OnClientConnectEvent>(*this);
