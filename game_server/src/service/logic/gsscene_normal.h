#ifndef GAME_SERVER_SRC_SERVICE_LOGIC_SCENE_NORMAL_H_
#define GAME_SERVER_SRC_SERVICE_LOGIC_SCENE_NORMAL_H_
...
#endif//GAME_SERVER_SRC_SERVICE_LOGIC_SCENE_NORMAL_H_
