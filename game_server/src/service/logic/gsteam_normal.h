#ifndef GAME_SERVER_SRC_SERVICE_LOGIC_LOGIC_PROTO_TEAM_NORMAL_H_
#define GAME_SERVER_SRC_SERVICE_LOGIC_LOGIC_PROTO_TEAM_NORMAL_H_
...
#endif//GAME_SERVER_SRC_SERVICE_LOGIC_LOGIC_PROTO_TEAM_NORMAL_H_
