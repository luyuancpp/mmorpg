...
type PlayerMigrationPbEvent struct {
	...
	SceneInfo            *ChangeRoomInfoPBComponent `protobuf:"bytes,9,opt,name=scene_info,json=sceneInfo,proto3" json:"scene_info,omitempty"`
...
func (x *PlayerMigrationPbEvent) GetSceneInfo() *ChangeRoomInfoPBComponent {
	if x != nil {
		return x.SceneInfo
	}
	return nil
...
const file_proto_logic_event_player_migration_event_proto_rawDesc = "" +
	"\n" +
	".proto/logic/event/player_migration_event.proto\x1a&proto/logic/component/scene_comp.proto\"\xf0\x02\n" +
	...
	"\n" +
	"scene_info\x18\t \x01(\v2\x1a.ChangeRoomInfoPBComponentR\tsceneInfoB\x18Z\x16game/generated/pb/gameb\x06proto3"
...
var file_proto_logic_event_player_migration_event_proto_goTypes = []any{
	...
	(*ChangeRoomInfoPBComponent)(nil), // 1: ChangeRoomInfoPBComponent
}
