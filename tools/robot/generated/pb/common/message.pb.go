...
type RoutingNodeInfo struct {
	...
	NodeInfo      *game.NodeInfo         `protobuf:"bytes,1,opt,name=node_info,json=nodeInfo,proto3" json:"node_info,omitempty"`     // 节点信息
...
func (x *RoutingNodeInfo) GetNodeInfo() *game.NodeInfo {
	if x != nil {
		return x.NodeInfo
	}
	return nil
...
type NodeRoutingMessageBody struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	NodeInfo      *game.NodeInfo         `protobuf:"bytes,2,opt,name=node_info,json=nodeInfo,proto3" json:"node_info,omitempty"` // 节点信息
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *NodeRoutingMessageBody) GetNodeInfo() *game.NodeInfo {
	if x != nil {
		return x.NodeInfo
	}
	return nil
...
type RoutePlayerMessageRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Body          []byte                 `protobuf:"bytes,1,opt,name=body,proto3" json:"body,omitempty"`                               // 消息内容（字符串）
	NodeList      []*game.NodeInfo       `protobuf:"bytes,2,rep,name=node_list,json=nodeList,proto3" json:"node_list,omitempty"`       // 节点列表
...
func (x *RoutePlayerMessageRequest) GetNodeList() []*game.NodeInfo {
	if x != nil {
		return x.NodeList
	}
	return nil
...
func (x *RoutePlayerMessageResponse) GetNodeList() []*game.NodeInfo {
	if x != nil {
		return x.NodeList
	}
	return nil
...
type RegisterGameNodeRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	RpcClient     *game.NetworkAddress   `protobuf:"bytes,1,opt,name=rpc_client,json=rpcClient,proto3" json:"rpc_client,omitempty"`                // 客户端 RPC 地址
	RpcServer     *game.NetworkAddress   `protobuf:"bytes,2,opt,name=rpc_server,json=rpcServer,proto3" json:"rpc_server,omitempty"`                // 服务器 RPC 地址
...
func (x *RegisterGameNodeRequest) GetRpcClient() *game.NetworkAddress {
	if x != nil {
		return x.RpcClient
	}
	return nil
...
func (x *RegisterGameNodeRequest) GetRpcServer() *game.NetworkAddress {
	if x != nil {
		return x.RpcServer
	}
	return nil
...
func (x *RegisterGateNodeRequest) GetRpcClient() *game.NetworkAddress {
	if x != nil {
		return x.RpcClient
	}
	return nil
...
type NodeHandshakeRequest struct {
	...
	SelfNode      *game.NodeInfo         `protobuf:"bytes,3,opt,name=self_node,json=selfNode,proto3" json:"self_node,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *NodeHandshakeRequest) GetSelfNode() *game.NodeInfo {
	if x != nil {
		return x.SelfNode
	}
	return nil
...
type NodeHandshakeResponse struct {
	...
	PeerNode      *game.NodeInfo         `protobuf:"bytes,2,opt,name=peer_node,json=peerNode,proto3" json:"peer_node,omitempty"`             // 对方的节点信息（返回的是对方）
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *NodeHandshakeResponse) GetPeerNode() *game.NodeInfo {
	if x != nil {
		return x.PeerNode
	}
	return nil
...
const file_proto_common_message_proto_rawDesc = "" +
	...
	"\tpeer_node\x18\x02 \x01(\v2\t.NodeInfoR\bpeerNodeB\x15Z\x13generated/pb/commonb\x06proto3"
