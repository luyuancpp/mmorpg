...
// 	protoc        v6.31.1
// source: proto/common/logic/component/buff_comp.proto
...
func (x *BuffContextPBComponent) Reset() {
	*x = BuffContextPBComponent{}
	mi := &file_proto_common_logic_component_buff_comp_proto_msgTypes[0]
...
func (*BuffContextPBComponent) Descriptor() ([]byte, []int) {
	return file_proto_common_logic_component_buff_comp_proto_rawDescGZIP(), []int{0}
}
...
func (x *BuffPeriodicBuffPbComponent) Reset() {
	*x = BuffPeriodicBuffPbComponent{}
	mi := &file_proto_common_logic_component_buff_comp_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*BuffPeriodicBuffPbComponent) Descriptor() ([]byte, []int) {
	return file_proto_common_logic_component_buff_comp_proto_rawDescGZIP(), []int{1}
}
...
func (x *BuffPbComponent) Reset() {
	*x = BuffPbComponent{}
	mi := &file_proto_common_logic_component_buff_comp_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*BuffPbComponent) Descriptor() ([]byte, []int) {
	return file_proto_common_logic_component_buff_comp_proto_rawDescGZIP(), []int{2}
}
...
func (x *DamageEventPbComponent) Reset() {
	*x = DamageEventPbComponent{}
	mi := &file_proto_common_logic_component_buff_comp_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*DamageEventPbComponent) Descriptor() ([]byte, []int) {
	return file_proto_common_logic_component_buff_comp_proto_rawDescGZIP(), []int{3}
}
...
func (x *BuffNoDamageOrSkillHitInLastSecondsPbComp) Reset() {
	*x = BuffNoDamageOrSkillHitInLastSecondsPbComp{}
	mi := &file_proto_common_logic_component_buff_comp_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*BuffNoDamageOrSkillHitInLastSecondsPbComp) Descriptor() ([]byte, []int) {
	return file_proto_common_logic_component_buff_comp_proto_rawDescGZIP(), []int{4}
}
...
var File_proto_common_logic_component_buff_comp_proto protoreflect.FileDescriptor

const file_proto_common_logic_component_buff_comp_proto_rawDesc = "" +
	"\n" +
	",proto/common/logic/component/buff_comp.proto\";\n" +
	...
	"\tlast_time\x18\x01 \x01(\x04R\blastTimeB.Z,robot/proto/common/logic/component;componentb\x06proto3"

var (
	file_proto_common_logic_component_buff_comp_proto_rawDescOnce sync.Once
	file_proto_common_logic_component_buff_comp_proto_rawDescData []byte
)

func file_proto_common_logic_component_buff_comp_proto_rawDescGZIP() []byte {
	file_proto_common_logic_component_buff_comp_proto_rawDescOnce.Do(func() {
		file_proto_common_logic_component_buff_comp_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_proto_common_logic_component_buff_comp_proto_rawDesc), len(file_proto_common_logic_component_buff_comp_proto_rawDesc)))
	})
	return file_proto_common_logic_component_buff_comp_proto_rawDescData
}

var file_proto_common_logic_component_buff_comp_proto_msgTypes = make([]protoimpl.MessageInfo, 6)
var file_proto_common_logic_component_buff_comp_proto_goTypes = []any{
...
var file_proto_common_logic_component_buff_comp_proto_depIdxs = []int32{
...
func init() { file_proto_common_logic_component_buff_comp_proto_init() }
func file_proto_common_logic_component_buff_comp_proto_init() {
	if File_proto_common_logic_component_buff_comp_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_proto_common_logic_component_buff_comp_proto_rawDesc), len(file_proto_common_logic_component_buff_comp_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   6,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_proto_common_logic_component_buff_comp_proto_goTypes,
		DependencyIndexes: file_proto_common_logic_component_buff_comp_proto_depIdxs,
		MessageInfos:      file_proto_common_logic_component_buff_comp_proto_msgTypes,
	}.Build()
	File_proto_common_logic_component_buff_comp_proto = out.File
	file_proto_common_logic_component_buff_comp_proto_goTypes = nil
	file_proto_common_logic_component_buff_comp_proto_depIdxs = nil
}
