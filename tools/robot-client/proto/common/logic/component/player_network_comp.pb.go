...
// 	protoc        v6.31.1
// source: proto/common/logic/component/player_network_comp.proto
...
func (x *PlayerSessionSnapshotPBComp) Reset() {
	*x = PlayerSessionSnapshotPBComp{}
	mi := &file_proto_common_logic_component_player_network_comp_proto_msgTypes[0]
...
func (*PlayerSessionSnapshotPBComp) Descriptor() ([]byte, []int) {
	return file_proto_common_logic_component_player_network_comp_proto_rawDescGZIP(), []int{0}
}
...
func (x *PlayerSessionSnapshotPBComp) GetLastRequestId() string {
	if x != nil {
...
var File_proto_common_logic_component_player_network_comp_proto protoreflect.FileDescriptor

const file_proto_common_logic_component_player_network_comp_proto_rawDesc = "" +
	"\n" +
	"6proto/common/logic/component/player_network_comp.proto\"\x95\x03\n" +
	...
	"\x05value\x18\x02 \x01(\rR\x05value:\x028\x01B.Z,robot/proto/common/logic/component;componentb\x06proto3"

var (
	file_proto_common_logic_component_player_network_comp_proto_rawDescOnce sync.Once
	file_proto_common_logic_component_player_network_comp_proto_rawDescData []byte
)

func file_proto_common_logic_component_player_network_comp_proto_rawDescGZIP() []byte {
	file_proto_common_logic_component_player_network_comp_proto_rawDescOnce.Do(func() {
		file_proto_common_logic_component_player_network_comp_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_proto_common_logic_component_player_network_comp_proto_rawDesc), len(file_proto_common_logic_component_player_network_comp_proto_rawDesc)))
	})
	return file_proto_common_logic_component_player_network_comp_proto_rawDescData
}

var file_proto_common_logic_component_player_network_comp_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_proto_common_logic_component_player_network_comp_proto_goTypes = []any{
	(*PlayerSessionSnapshotPBComp)(nil), // 0: PlayerSessionSnapshotPBComp
	nil,                                 // 1: PlayerSessionSnapshotPBComp.NodeIdEntry
}
var file_proto_common_logic_component_player_network_comp_proto_depIdxs = []int32{
...
func init() { file_proto_common_logic_component_player_network_comp_proto_init() }
func file_proto_common_logic_component_player_network_comp_proto_init() {
	if File_proto_common_logic_component_player_network_comp_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_proto_common_logic_component_player_network_comp_proto_rawDesc), len(file_proto_common_logic_component_player_network_comp_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_proto_common_logic_component_player_network_comp_proto_goTypes,
		DependencyIndexes: file_proto_common_logic_component_player_network_comp_proto_depIdxs,
		MessageInfos:      file_proto_common_logic_component_player_network_comp_proto_msgTypes,
	}.Build()
	File_proto_common_logic_component_player_network_comp_proto = out.File
	file_proto_common_logic_component_player_network_comp_proto_goTypes = nil
	file_proto_common_logic_component_player_network_comp_proto_depIdxs = nil
}
