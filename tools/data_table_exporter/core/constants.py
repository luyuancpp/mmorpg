...
PROJECT_GENERATED_CODE_PROTO_TIP_DIR = PROJECT_GENERATED_CODE_DIR + "proto/tip/"

PROJECT_OPERATOR_XLSX = XLSX_DIR + 'operator/Operator.xlsx'
PROJECT_GENERATED_CODE_PROTO_OPERATOR_DIR = PROJECT_GENERATED_CODE_DIR + "proto/operator/"
