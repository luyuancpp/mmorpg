...
var (
	...
	E_OptionTableId = &file_proto_service_go_grpc_db_proto_option_proto_extTypes[1] //表ID
	// optional string OptionTableName = 500001;
	E_OptionTableName = &file_proto_service_go_grpc_db_proto_option_proto_extTypes[2] //表名
	// optional string OptionPrimaryKey = 500002;
	E_OptionPrimaryKey = &file_proto_service_go_grpc_db_proto_option_proto_extTypes[3] //主键
	// optional string OptionForeignKey = 500003;
	E_OptionForeignKey = &file_proto_service_go_grpc_db_proto_option_proto_extTypes[4] //外键
	// optional string OptionForeignReferences = 500005;
	E_OptionForeignReferences = &file_proto_service_go_grpc_db_proto_option_proto_extTypes[5] //外键的关联表
	// optional string OptionAutoIncrementKey = 500006;
	E_OptionAutoIncrementKey = &file_proto_service_go_grpc_db_proto_option_proto_extTypes[6] //自增长的Key
	// optional string OptionBackupTableName = 500007;
	E_OptionBackupTableName = &file_proto_service_go_grpc_db_proto_option_proto_extTypes[7] //备份表的名称
	// optional bool OptionLoadOnly = 500008;
	E_OptionLoadOnly = &file_proto_service_go_grpc_db_proto_option_proto_extTypes[8] //只用于数据加载
	// optional string OptionProcedureName = 500009;
	E_OptionProcedureName = &file_proto_service_go_grpc_db_proto_option_proto_extTypes[9] //存储过程名称
	// optional string OptionProcedureResult = 500010;
	E_OptionProcedureResult = &file_proto_service_go_grpc_db_proto_option_proto_extTypes[10] //存储过程返回结果的PB结构Name
	// optional string OptionIndex = 500011;
	E_OptionIndex = &file_proto_service_go_grpc_db_proto_option_proto_extTypes[11] //建立索引
	// optional string OptionUniqueKey = 500012;
	E_OptionUniqueKey = &file_proto_service_go_grpc_db_proto_option_proto_extTypes[12] //
	// optional bool OptionIsPlayerDatabase = 500013;
	E_OptionIsPlayerDatabase = &file_proto_service_go_grpc_db_proto_option_proto_extTypes[13] // 标识是否是玩家数据库
	// ---------- 属性同步相关 ----------
	//
	// optional bool OptionBaseAttributeSync = 700000;
	E_OptionBaseAttributeSync = &file_proto_service_go_grpc_db_proto_option_proto_extTypes[14] // 基础属性同步
	// optional bool OptionDeltaAttributeSync = 700001;
	E_OptionDeltaAttributeSync = &file_proto_service_go_grpc_db_proto_option_proto_extTypes[15] // 增量属性同步
)

// Extension fields to descriptorpb.FieldOptions.
var (
	// optional uint32 OptionRepeatLimit = 600000;
	E_OptionRepeatLimit = &file_proto_service_go_grpc_db_proto_option_proto_extTypes[16] // repeat 字段限制的个数
	// optional string OptionDBFieldExtra = 600001;
	E_OptionDBFieldExtra = &file_proto_service_go_grpc_db_proto_option_proto_extTypes[17] // 创建数据库要用到得额外信息，如果没有该属性表示非数据库字段
	// optional bool OptionDBReadOnly = 600002;
	E_OptionDBReadOnly = &file_proto_service_go_grpc_db_proto_option_proto_extTypes[18] // 该字段对DB是否只读
	// optional string OptionDBNamePrefix = 600003;
	E_OptionDBNamePrefix = &file_proto_service_go_grpc_db_proto_option_proto_extTypes[19] // 数据库名称前缀
	// optional string OptionDBLoadSql = 600004;
	E_OptionDBLoadSql = &file_proto_service_go_grpc_db_proto_option_proto_extTypes[20] // 数据加载SQL语句
	// optional bool OptionDBNeedEscape = 600005;
	E_OptionDBNeedEscape = &file_proto_service_go_grpc_db_proto_option_proto_extTypes[21] // 字段是否需要转义存储
	// optional bool OptionDBProcParam = 600006;
	E_OptionDBProcParam = &file_proto_service_go_grpc_db_proto_option_proto_extTypes[22] // 是否存储过程参数
	// optional string OptionOldName = 600007;
	E_OptionOldName = &file_proto_service_go_grpc_db_proto_option_proto_extTypes[23] //用来自动修改字段名
	// optional string OptionTable = 600008;
	E_OptionTable = &file_proto_service_go_grpc_db_proto_option_proto_extTypes[24] // 建表名称
	// optional string OptionBackUpTabel = 600009;
	E_OptionBackUpTabel = &file_proto_service_go_grpc_db_proto_option_proto_extTypes[25] //备份表
)
...
const file_proto_service_go_grpc_db_proto_option_proto_rawDesc = "" +
	"\n" +
	"+proto/service/go/grpc/db/proto_option.proto\x1a google/protobuf/descriptor.proto*`\n" +
	"\bNodeType\x12\x14\n" +
...
var file_proto_service_go_grpc_db_proto_option_proto_depIdxs = []int32{
	...
	4,  // 13: OptionIsPlayerDatabase:extendee -> google.protobuf.MessageOptions
	4,  // 14: OptionBaseAttributeSync:extendee -> google.protobuf.MessageOptions
	4,  // 15: OptionDeltaAttributeSync:extendee -> google.protobuf.MessageOptions
	5,  // 16: OptionRepeatLimit:extendee -> google.protobuf.FieldOptions
	5,  // 17: OptionDBFieldExtra:extendee -> google.protobuf.FieldOptions
	5,  // 18: OptionDBReadOnly:extendee -> google.protobuf.FieldOptions
	5,  // 19: OptionDBNamePrefix:extendee -> google.protobuf.FieldOptions
	5,  // 20: OptionDBLoadSql:extendee -> google.protobuf.FieldOptions
	5,  // 21: OptionDBNeedEscape:extendee -> google.protobuf.FieldOptions
	5,  // 22: OptionDBProcParam:extendee -> google.protobuf.FieldOptions
	5,  // 23: OptionOldName:extendee -> google.protobuf.FieldOptions
	5,  // 24: OptionTable:extendee -> google.protobuf.FieldOptions
	5,  // 25: OptionBackUpTabel:extendee -> google.protobuf.FieldOptions
	0,  // 26: OptionFileDefaultNode:type_name -> NodeType
