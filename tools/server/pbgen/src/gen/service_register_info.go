...
func WriteServiceRegisterInfoFile() {
	...
	util.Wg.Add(1)
	go writePlayerServiceInstanceFiles("instance", isGsPlayerHandler, config.GsPlayerMethodHandleDir, config.PlayerServiceName)
	util.Wg.Add(1)
	go writePlayerServiceInstanceFiles("instance", isCentrePlayerHandler, config.CentrePlayerMethodHandleDir, config.PlayerServiceName)
	util.Wg.Add(1)
