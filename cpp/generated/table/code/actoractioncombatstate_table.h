...
public:
    ...
    std::pair<ActorActionCombatStateTable*, uint32_t> GetTable(uint32_t tableId);
    std::pair<ActorActionCombatStateTable*, uint32_t> GetTableWithoutErrorLogging(uint32_t tableId);
