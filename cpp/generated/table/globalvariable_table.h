...
using GlobalVariableTableTempPtr = WarnOnSavePtr<const GlobalVariableTable>;

class GlobalVariableTableManager {
public:
    using KeyValueDataType = std::unordered_map<uint32_t, const GlobalVariableTableTempPtr>;
