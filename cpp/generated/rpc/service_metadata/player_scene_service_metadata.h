...
constexpr uint32_t SceneSceneClientPlayerNotifyEnterSceneMessageId = 62;
...
constexpr uint32_t SceneSceneClientPlayerSceneInfoC2SMessageId = 40;
...
constexpr uint32_t SceneSceneClientPlayerNotifySceneInfoMessageId = 12;
...
constexpr uint32_t SceneSceneClientPlayerNotifyActorCreateMessageId = 11;
...
constexpr uint32_t SceneSceneClientPlayerNotifyActorDestroyMessageId = 23;
...
constexpr uint32_t SceneSceneClientPlayerNotifyActorListCreateMessageId = 14;
...
constexpr uint32_t SceneSceneClientPlayerNotifyActorListDestroyMessageId = 51;
