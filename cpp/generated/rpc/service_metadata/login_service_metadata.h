...
constexpr uint32_t ClientPlayerLoginLoginMessageId = 34;
...
constexpr uint32_t ClientPlayerLoginCreatePlayerMessageId = 7;
...
constexpr uint32_t ClientPlayerLoginEnterGameMessageId = 8;
...
constexpr uint32_t ClientPlayerLoginLeaveGameMessageId = 29;
...
constexpr uint32_t ClientPlayerLoginDisconnectMessageId = 32;
