...
constexpr uint32_t ScenePlayerSyncSyncBaseAttributeMessageId = 16;
...
constexpr uint32_t ScenePlayerSyncSyncAttribute2FramesMessageId = 61;
...
constexpr uint32_t ScenePlayerSyncSyncAttribute5FramesMessageId = 35;
...
constexpr uint32_t ScenePlayerSyncSyncAttribute30FramesMessageId = 75;
...
constexpr uint32_t ScenePlayerSyncSyncAttribute60FramesMessageId = 80;
