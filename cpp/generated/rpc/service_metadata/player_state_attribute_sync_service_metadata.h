...
constexpr uint32_t ScenePlayerSyncSyncBaseAttributeMessageId = 80;
...
constexpr uint32_t ScenePlayerSyncSyncAttribute2FramesMessageId = 16;
...
constexpr uint32_t ScenePlayerSyncSyncAttribute5FramesMessageId = 4;
...
constexpr uint32_t ScenePlayerSyncSyncAttribute10FramesMessageId = 39;
...
constexpr uint32_t ScenePlayerSyncSyncAttribute30FramesMessageId = 17;
...
constexpr uint32_t ScenePlayerSyncSyncAttribute60FramesMessageId = 55;
