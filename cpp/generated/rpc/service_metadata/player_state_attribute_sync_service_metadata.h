...
constexpr uint32_t ScenePlayerSyncSyncBaseAttributeMessageId = 17;
...
constexpr uint32_t ScenePlayerSyncSyncAttribute2FramesMessageId = 42;
...
constexpr uint32_t ScenePlayerSyncSyncAttribute5FramesMessageId = 41;
...
constexpr uint32_t ScenePlayerSyncSyncAttribute30FramesMessageId = 76;
...
constexpr uint32_t ScenePlayerSyncSyncAttribute60FramesMessageId = 53;
