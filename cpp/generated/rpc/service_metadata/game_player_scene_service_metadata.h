...
constexpr uint32_t SceneScenePlayerEnterSceneMessageId = 50;
...
constexpr uint32_t SceneScenePlayerLeaveSceneMessageId = 70;
...
constexpr uint32_t SceneScenePlayerEnterSceneS2CMessageId = 4;
