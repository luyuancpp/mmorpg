...
constexpr uint32_t CentrePlayerSceneEnterSceneMessageId = 2;
...
constexpr uint32_t CentrePlayerSceneLeaveSceneMessageId = 32;
...
constexpr uint32_t CentrePlayerSceneLeaveSceneAsyncSavePlayerCompleteMessageId = 25;
...
constexpr uint32_t CentrePlayerSceneSceneInfoC2SMessageId = 40;
