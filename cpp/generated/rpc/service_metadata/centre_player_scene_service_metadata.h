...
constexpr uint32_t CentrePlayerSceneEnterSceneMessageId = 74;
...
constexpr uint32_t CentrePlayerSceneLeaveSceneMessageId = 49;
...
constexpr uint32_t CentrePlayerSceneLeaveSceneAsyncSavePlayerCompleteMessageId = 75;
...
constexpr uint32_t CentrePlayerSceneSceneInfoC2SMessageId = 38;
