...
constexpr uint32_t CentrePlayerSceneEnterSceneMessageId = 61;
...
constexpr uint32_t CentrePlayerSceneLeaveSceneMessageId = 27;
...
constexpr uint32_t CentrePlayerSceneLeaveSceneAsyncSavePlayerCompleteMessageId = 37;
...
constexpr uint32_t CentrePlayerSceneSceneInfoC2SMessageId = 28;
