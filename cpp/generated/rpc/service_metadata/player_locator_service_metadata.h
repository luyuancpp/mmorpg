...
constexpr uint32_t PlayerLocatorSetLocationMessageId = 16;
...
constexpr uint32_t PlayerLocatorGetLocationMessageId = 46;
...
constexpr uint32_t PlayerLocatorMarkOfflineMessageId = 44;
