...
void InitMessageInfo()
{
    ...
    gRpcServiceRegistry[CentreHandshakeMessageId] = RpcService{"Centre", "Handshake", std::make_unique_for_overwrite<::HandshakeRequest>(), std::make_unique_for_overwrite<::HandshakeResponse>(), std::make_unique_for_overwrite<CentreImpl>(), 0, eNodeType::CentreNodeService};
    ...
    gRpcServiceRegistry[SceneHandshakeMessageId] = RpcService{"Scene", "Handshake", std::make_unique_for_overwrite<::HandshakeRequest>(), std::make_unique_for_overwrite<::HandshakeResponse>(), std::make_unique_for_overwrite<SceneImpl>(), 0, eNodeType::SceneNodeService};
    ...
    gRpcServiceRegistry[GateHandshakeMessageId] = RpcService{"Gate", "Handshake", std::make_unique_for_overwrite<::HandshakeRequest>(), std::make_unique_for_overwrite<::HandshakeResponse>(), std::make_unique_for_overwrite<GateImpl>(), 0, eNodeType::GateNodeService};
