...
namespace scene_manager{void SendSceneManagerGateConnect(entt::registry& , entt::entity , const google::protobuf::Message& , const std::vector<std::string>& , const std::vector<std::string>& );}
...
void InitMessageInfo()
{
    ...
    gRpcServiceRegistry[SceneManagerLeaveSceneByCentreMessageId] = RpcService{"SceneManager", "LeaveSceneByCentre", std::make_unique_for_overwrite<::scene_manager::LeaveSceneByCentreRequest>(), std::make_unique_for_overwrite<::Empty>(), nullptr, 1, eNodeType::SceneManagerNodeService, scene_manager::SendSceneManagerLeaveSceneByCentre};
    gRpcServiceRegistry[SceneManagerGateConnectMessageId] = RpcService{"SceneManager", "GateConnect", std::make_unique_for_overwrite<::scene_manager::GateHeartbeat>(), std::make_unique_for_overwrite<::scene_manager::GateCommand>(), nullptr, 1, eNodeType::SceneManagerNodeService, scene_manager::SendSceneManagerGateConnect};
