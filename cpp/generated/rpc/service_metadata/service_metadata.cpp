...
#include "rpc/service_metadata/player_locatorservice_metadata.h"
#include "rpc/service_metadata/etcdservice_metadata.h"
#include "rpc/service_metadata/etcdservice_metadata.h"
#include "rpc/service_metadata/etcdservice_metadata.h"
#include "rpc/service_metadata/loginservice_metadata.h"
#include "rpc/service_metadata/centre_playerservice_metadata.h"
#include "rpc/service_metadata/centre_player_sceneservice_metadata.h"
#include "rpc/service_metadata/centre_sceneservice_metadata.h"
#include "rpc/service_metadata/centre_serviceservice_metadata.h"
#include "rpc/service_metadata/game_client_playerservice_metadata.h"
#include "rpc/service_metadata/game_playerservice_metadata.h"
#include "rpc/service_metadata/game_player_sceneservice_metadata.h"
#include "rpc/service_metadata/game_sceneservice_metadata.h"
#include "rpc/service_metadata/game_serviceservice_metadata.h"
#include "rpc/service_metadata/player_sceneservice_metadata.h"
#include "rpc/service_metadata/player_skillservice_metadata.h"
#include "rpc/service_metadata/player_state_attribute_syncservice_metadata.h"
...
void InitMessageInfo()
{
    ...
    gRpcServiceRegistry[CentreRegisterNodeSessionMessageId] = RpcService{"Centre", "RegisterNodeSession", std::make_unique_for_overwrite<::RegisterNodeSessionRequest>(), std::make_unique_for_overwrite<::RegisterNodeSessionResponse>(), std::make_unique_for_overwrite<CentreImpl>(), 0, eNodeType::CentreNodeService};
    ...
    gRpcServiceRegistry[SceneRegisterNodeSessionMessageId] = RpcService{"Scene", "RegisterNodeSession", std::make_unique_for_overwrite<::RegisterNodeSessionRequest>(), std::make_unique_for_overwrite<::RegisterNodeSessionResponse>(), std::make_unique_for_overwrite<SceneImpl>(), 0, eNodeType::SceneNodeService};
    ...
    gRpcServiceRegistry[GateRegisterNodeSessionMessageId] = RpcService{"Gate", "RegisterNodeSession", std::make_unique_for_overwrite<::RegisterNodeSessionRequest>(), std::make_unique_for_overwrite<::RegisterNodeSessionResponse>(), std::make_unique_for_overwrite<GateImpl>(), 0, eNodeType::GateNodeService};
