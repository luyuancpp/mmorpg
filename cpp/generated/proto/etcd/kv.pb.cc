...
static const ::_pb::EnumDescriptor* file_level_enum_descriptors_proto_2fetcd_2fkv_2eproto[1];
...
const char descriptor_table_protodef_proto_2fetcd_2fkv_2eproto[] ABSL_ATTRIBUTE_SECTION_VARIABLE(
    protodesc_cold) = {
    "\n\023proto/etcd/kv.proto\022\006mvccpb\032\030proto/etc"
    ...
    ".mvccpb.Event.EventType\022\034\n\002kv\030\002 \001(\0132\020.mv"
    "ccpb.KeyValue\022!\n\007prev_kv\030\003 \001(\0132\020.mvccpb."
    "KeyValue\" \n\tEventType\022\007\n\003PUT\020\000\022\n\n\006DELETE"
    "\020\001B\023Z\021game/etcdserverpbb\006proto3"
};
static const ::_pbi::DescriptorTable* const descriptor_table_proto_2fetcd_2fkv_2eproto_deps[1] =
    {
...
PROTOBUF_CONSTINIT const ::_pbi::DescriptorTable descriptor_table_proto_2fetcd_2fkv_2eproto = {
    ...
    descriptor_table_proto_2fetcd_2fkv_2eproto_deps,
    1,
    2,
    schemas,
...
inline PROTOBUF_NDEBUG_INLINE KeyValue::Impl_::Impl_(
    ...
    const Impl_& from, const ::mvccpb::KeyValue& from_msg)
...
const ::_pbi::TcParseTable<3, 6, 0, 0, 2> KeyValue::_table_ = {
  {
    0,  // no _has_bits_
    0, // no _extensions_
    ...
    {::_pbi::TcParser::SingularVarintNoZag1<::uint64_t, offsetof(KeyValue, _impl_.create_revision_), 63>(),
     {16, 63, 0, PROTOBUF_FIELD_OFFSET(KeyValue, _impl_.create_revision_)}},
    // int64 mod_revision = 3;
    {::_pbi::TcParser::SingularVarintNoZag1<::uint64_t, offsetof(KeyValue, _impl_.mod_revision_), 63>(),
     {24, 63, 0, PROTOBUF_FIELD_OFFSET(KeyValue, _impl_.mod_revision_)}},
    // int64 version = 4;
    {::_pbi::TcParser::SingularVarintNoZag1<::uint64_t, offsetof(KeyValue, _impl_.version_), 63>(),
     {32, 63, 0, PROTOBUF_FIELD_OFFSET(KeyValue, _impl_.version_)}},
    // bytes value = 5;
    {::_pbi::TcParser::FastBS1,
     {42, 63, 0, PROTOBUF_FIELD_OFFSET(KeyValue, _impl_.value_)}},
    // int64 lease = 6;
    {::_pbi::TcParser::SingularVarintNoZag1<::uint64_t, offsetof(KeyValue, _impl_.lease_), 63>(),
     {48, 63, 0, PROTOBUF_FIELD_OFFSET(KeyValue, _impl_.lease_)}},
    {::_pbi::TcParser::MiniParse, {}},
  }}, {{
    65535, 65535
  }}, {{
    ...
    // int64 create_revision = 2;
    {PROTOBUF_FIELD_OFFSET(KeyValue, _impl_.create_revision_), 0, 0,
    (0 | ::_fl::kFcSingular | ::_fl::kInt64)},
    // int64 mod_revision = 3;
    {PROTOBUF_FIELD_OFFSET(KeyValue, _impl_.mod_revision_), 0, 0,
    (0 | ::_fl::kFcSingular | ::_fl::kInt64)},
    // int64 version = 4;
    {PROTOBUF_FIELD_OFFSET(KeyValue, _impl_.version_), 0, 0,
    (0 | ::_fl::kFcSingular | ::_fl::kInt64)},
    // bytes value = 5;
    {PROTOBUF_FIELD_OFFSET(KeyValue, _impl_.value_), 0, 0,
    (0 | ::_fl::kFcSingular | ::_fl::kBytes | ::_fl::kRepAString)},
    // int64 lease = 6;
    {PROTOBUF_FIELD_OFFSET(KeyValue, _impl_.lease_), 0, 0,
    (0 | ::_fl::kFcSingular | ::_fl::kInt64)},
  }},
  // no aux_entries
  {{
...
inline PROTOBUF_NDEBUG_INLINE Event::Impl_::Impl_(
    ::google::protobuf::internal::InternalVisibility visibility, ::google::protobuf::Arena* arena,
    const Impl_& from, const ::mvccpb::Event& from_msg)
...
Event::Event(
  ...
  _impl_.kv_ = (cached_has_bits & 0x00000001u) ? ::google::protobuf::Message::CopyConstruct<::mvccpb::KeyValue>(
...
PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1
const ::_pbi::TcParseTable<2, 3, 2, 0, 2> Event::_table_ = {
  {
    ...
    // .mvccpb.Event.EventType type = 1;
    {PROTOBUF_FIELD_OFFSET(Event, _impl_.type_), -1, 0,
  ...
  if (cached_has_bits & 0x00000003u) {
    if (cached_has_bits & 0x00000001u) {
      ...
      if (_this->_impl_.kv_ == nullptr) {
        _this->_impl_.kv_ =
            ::google::protobuf::Message::CopyConstruct<::mvccpb::KeyValue>(arena, *from._impl_.kv_);
      } else {
