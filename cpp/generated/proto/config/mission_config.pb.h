...
/* @@protoc_insertion_point(class_definition:MissionTable) */ {
 public:
  ...
  void operator delete(MissionTable* msg, std::destroying_delete_t) {
    SharedDtor(*msg);
  ...
  MissionTable* New(::google::protobuf::Arena* arena = nullptr) const {
...
/* @@protoc_insertion_point(class_definition:MissionTabledData) */ {
 public:
...
#if defined(PROTOBUF_CUSTOM_VTABLE)
  void operator delete(MissionTabledData* msg, std::destroying_delete_t) {
    SharedDtor(*msg);
  ...
  MissionTabledData* New(::google::protobuf::Arena* arena = nullptr) const {
