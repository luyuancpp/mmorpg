...
/* @@protoc_insertion_point(class_definition:MainSceneTable) */ {
 public:
  ...
  void operator delete(MainSceneTable* msg, std::destroying_delete_t) {
    SharedDtor(*msg);
  ...
  MainSceneTable* New(::google::protobuf::Arena* arena = nullptr) const {
...
class MainSceneTabledData final
    : public ::google::protobuf::Message
/* @@protoc_insertion_point(class_definition:MainSceneTabledData) */ {
 public:
...
#if defined(PROTOBUF_CUSTOM_VTABLE)
  void operator delete(MainSceneTabledData* msg, std::destroying_delete_t) {
    SharedDtor(*msg);
  ...
  MainSceneTabledData* New(::google::protobuf::Arena* arena = nullptr) const {
