...
// source: proto/service/rpc/centre/centre_player.proto
// Protobuf C++ Version: 6.31.1

#ifndef proto_2fservice_2frpc_2fcentre_2fcentre_5fplayer_2eproto_2epb_2eh
#define proto_2fservice_2frpc_2fcentre_2fcentre_5fplayer_2eproto_2epb_2eh
...
#define PROTOBUF_INTERNAL_EXPORT_proto_2fservice_2frpc_2fcentre_2fcentre_5fplayer_2eproto
...
struct TableStruct_proto_2fservice_2frpc_2fcentre_2fcentre_5fplayer_2eproto {
  static const ::uint32_t offsets[];
};
extern "C" {
extern const ::google::protobuf::internal::DescriptorTable descriptor_table_proto_2fservice_2frpc_2fcentre_2fcentre_5fplayer_2eproto;
}  // extern "C"
...
extern const ::google::protobuf::internal::ClassDataFull CentreKickPlayerRequest_class_data_;
namespace google {
namespace protobuf {
}  // namespace protobuf
}  // namespace google
...
class CentreKickPlayerRequest final : public ::google::protobuf::Message
/* @@protoc_insertion_point(class_definition:CentreKickPlayerRequest) */ {
 public:
  ...
  void operator delete(CentreKickPlayerRequest* PROTOBUF_NONNULL msg, std::destroying_delete_t) {
    SharedDtor(*msg);
  ...
  explicit PROTOBUF_CONSTEXPR CentreKickPlayerRequest(::google::protobuf::internal::ConstantInitialized);
  ...
  inline void Swap(CentreKickPlayerRequest* PROTOBUF_NONNULL other) {
  ...
  void UnsafeArenaSwap(CentreKickPlayerRequest* PROTOBUF_NONNULL other) {
    if (other == this) return;
  ...
  CentreKickPlayerRequest* PROTOBUF_NONNULL New(::google::protobuf::Arena* PROTOBUF_NULLABLE arena = nullptr) const {
  ...
  void InternalSwap(CentreKickPlayerRequest* PROTOBUF_NONNULL other);
 private:
  template <typename T>
 ...
 protected:
  explicit CentreKickPlayerRequest(::google::protobuf::Arena* PROTOBUF_NULLABLE arena);
  CentreKickPlayerRequest(::google::protobuf::Arena* PROTOBUF_NULLABLE arena, const CentreKickPlayerRequest& from);
  CentreKickPlayerRequest(
      ::google::protobuf::Arena* PROTOBUF_NULLABLE arena, CentreKickPlayerRequest&& from) noexcept
 ...
 private:
  ...
  union { Impl_ _impl_; };
  friend struct ::TableStruct_proto_2fservice_2frpc_2fcentre_2fcentre_5fplayer_2eproto;
};
...
class CentrePlayerUtility : public ::google::protobuf::Service {
 ...
 public:
  ...
  virtual void KickPlayer(::google::protobuf::RpcController* PROTOBUF_NULLABLE controller,
                        const ::CentreKickPlayerRequest* PROTOBUF_NONNULL request,
                        ::Empty* PROTOBUF_NONNULL response,
                        ::google::protobuf::Closure* PROTOBUF_NULLABLE done);
...
class CentrePlayerUtility_Stub final : public CentrePlayerUtility {
 public:
  CentrePlayerUtility_Stub(::google::protobuf::RpcChannel* PROTOBUF_NULLABLE channel);
  CentrePlayerUtility_Stub(::google::protobuf::RpcChannel* PROTOBUF_NULLABLE channel,
...
inline void CentreKickPlayerRequest::unsafe_arena_set_allocated_reason(
...
inline ::TipInfoMessage* PROTOBUF_NULLABLE CentreKickPlayerRequest::release_reason() {
  ::google::protobuf::internal::TSanWrite(&_impl_);
...
inline ::TipInfoMessage* PROTOBUF_NULLABLE CentreKickPlayerRequest::unsafe_arena_release_reason() {
  ::google::protobuf::internal::TSanWrite(&_impl_);
...
inline ::TipInfoMessage* PROTOBUF_NONNULL CentreKickPlayerRequest::_internal_mutable_reason() {
  ::google::protobuf::internal::TSanWrite(&_impl_);
...
inline ::TipInfoMessage* PROTOBUF_NONNULL CentreKickPlayerRequest::mutable_reason()
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
  _impl_._has_bits_[0] |= 0x00000002u;
...
inline void CentreKickPlayerRequest::set_allocated_reason(::TipInfoMessage* PROTOBUF_NULLABLE value) {
...
PROTOBUF_ALWAYS_INLINE void CentreKickPlayerRequest::set_operator_(Arg_&& arg, Args_... args) {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  _impl_._has_bits_[0] |= 0x00000001u;
...
inline ::std::string* PROTOBUF_NONNULL CentreKickPlayerRequest::mutable_operator_()
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
...
inline ::std::string* PROTOBUF_NONNULL CentreKickPlayerRequest::_internal_mutable_operator_() {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  _impl_._has_bits_[0] |= 0x00000001u;
  return _impl_.operator__.Mutable( GetArena());
}
inline ::std::string* PROTOBUF_NULLABLE CentreKickPlayerRequest::release_operator_() {
  ::google::protobuf::internal::TSanWrite(&_impl_);
...
inline void CentreKickPlayerRequest::set_allocated_operator_(::std::string* PROTOBUF_NULLABLE value) {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  if (value != nullptr) {
    _impl_._has_bits_[0] |= 0x00000001u;
  } else {
...
#endif  // proto_2fservice_2frpc_2fcentre_2fcentre_5fplayer_2eproto_2epb_2eh
