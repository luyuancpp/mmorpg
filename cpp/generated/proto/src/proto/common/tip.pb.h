...
/* @@protoc_insertion_point(class_definition:TipInfoMessage) */ {
 public:
  ...
  void operator delete(TipInfoMessage* msg, std::destroying_delete_t) {
    SharedDtor(*msg);
  ...
  TipInfoMessage* New(::google::protobuf::Arena* arena = nullptr) const {
...
inline std::string* TipInfoMessage::add_parameters() ABSL_ATTRIBUTE_LIFETIME_BOUND {
  ::google::protobuf::internal::TSanWrite(&_impl_);
