...
class CombatStateDetailsPbComponent final
...
/* @@protoc_insertion_point(class_definition:CombatStateDetailsPbComponent) */ {
 public:
  ...
  void operator delete(CombatStateDetailsPbComponent* msg, std::destroying_delete_t) {
    SharedDtor(*msg);
  ...
  CombatStateDetailsPbComponent* New(::google::protobuf::Arena* arena = nullptr) const {
...
class CombatStateCollectionPbComponent final
    : public ::google::protobuf::Message
/* @@protoc_insertion_point(class_definition:CombatStateCollectionPbComponent) */ {
 public:
...
#if defined(PROTOBUF_CUSTOM_VTABLE)
  void operator delete(CombatStateCollectionPbComponent* msg, std::destroying_delete_t) {
    SharedDtor(*msg);
  ...
  CombatStateCollectionPbComponent* New(::google::protobuf::Arena* arena = nullptr) const {
