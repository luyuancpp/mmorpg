...
class DerivedAttributesPbComponent final
...
/* @@protoc_insertion_point(class_definition:DerivedAttributesPbComponent) */ {
 public:
  ...
  void operator delete(DerivedAttributesPbComponent* msg, std::destroying_delete_t) {
    SharedDtor(*msg);
  ...
  DerivedAttributesPbComponent* New(::google::protobuf::Arena* arena = nullptr) const {
...
class CalculatedAttributesPbComponent final
    : public ::google::protobuf::Message
/* @@protoc_insertion_point(class_definition:CalculatedAttributesPbComponent) */ {
 public:
...
#if defined(PROTOBUF_CUSTOM_VTABLE)
  void operator delete(CalculatedAttributesPbComponent* msg, std::destroying_delete_t) {
    SharedDtor(*msg);
  ...
  CalculatedAttributesPbComponent* New(::google::protobuf::Arena* arena = nullptr) const {
...
class CombatStateFlagsPbComponent final
    : public ::google::protobuf::Message
/* @@protoc_insertion_point(class_definition:CombatStateFlagsPbComponent) */ {
 public:
...
#if defined(PROTOBUF_CUSTOM_VTABLE)
  void operator delete(CombatStateFlagsPbComponent* msg, std::destroying_delete_t) {
    SharedDtor(*msg);
  ...
  CombatStateFlagsPbComponent* New(::google::protobuf::Arena* arena = nullptr) const {
