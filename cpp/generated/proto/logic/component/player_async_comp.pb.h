...
class PlayerGameNodeEnteryInfoPBComponent final
...
/* @@protoc_insertion_point(class_definition:PlayerGameNodeEnteryInfoPBComponent) */ {
 public:
  ...
  void operator delete(PlayerGameNodeEnteryInfoPBComponent* msg, std::destroying_delete_t) {
    SharedDtor(*msg);
  ...
  PlayerGameNodeEnteryInfoPBComponent* New(::google::protobuf::Arena* arena = nullptr) const {
