...
const std::unordered_map<eNodeType, std::string> nodeTypeNameMap = {
	...
	{eNodeType::SlgMapNodeService, eNodeType_Name(SlgMapNodeService)},
	{eNodeType::SlgBattleNodeService, eNodeType_Name(SlgBattleNodeService)},
	{eNodeType::TurnBasedBattleNodeService, eNodeType_Name(TurnBasedBattleNodeService)},
	{eNodeType::TurnBasedDungeonNodeService, eNodeType_Name(TurnBasedDungeonNodeService)}};
