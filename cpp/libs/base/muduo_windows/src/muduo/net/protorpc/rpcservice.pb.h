...
/* @@protoc_insertion_point(class_definition:muduo.net.ListRpcResponse) */ {
 public:
  ...
  void operator delete(ListRpcResponse* msg, std::destroying_delete_t) {
    SharedDtor(*msg);
  ...
  ListRpcResponse* New(::google::protobuf::Arena* arena = nullptr) const {
...
/* @@protoc_insertion_point(class_definition:muduo.net.ListRpcRequest) */ {
 public:
...
#if defined(PROTOBUF_CUSTOM_VTABLE)
  void operator delete(ListRpcRequest* msg, std::destroying_delete_t) {
    SharedDtor(*msg);
  ...
  ListRpcRequest* New(::google::protobuf::Arena* arena = nullptr) const {
...
/* @@protoc_insertion_point(class_definition:muduo.net.GetServiceResponse) */ {
 public:
...
#if defined(PROTOBUF_CUSTOM_VTABLE)
  void operator delete(GetServiceResponse* msg, std::destroying_delete_t) {
    SharedDtor(*msg);
  ...
  GetServiceResponse* New(::google::protobuf::Arena* arena = nullptr) const {
...
/* @@protoc_insertion_point(class_definition:muduo.net.GetServiceRequest) */ {
 public:
...
#if defined(PROTOBUF_CUSTOM_VTABLE)
  void operator delete(GetServiceRequest* msg, std::destroying_delete_t) {
    SharedDtor(*msg);
  ...
  GetServiceRequest* New(::google::protobuf::Arena* arena = nullptr) const {
