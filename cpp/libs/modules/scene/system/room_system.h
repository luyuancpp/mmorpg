...
public:
     ...
     */
    static entt::entity CreateSceneToSceneNode(const CreateSceneNodeRoomParam& param);

    /**
     * @brief DestroyScene destroys a scene.
     * @param param Parameters for destroying the scene.
     */
    static void DestroyScene(const DestroyRoomParam& param);
     ...
     */
    static uint32_t CheckPlayerEnterScene(const EnterRoomParam& param);

    /**
     * @brief EnterScene handles the action of a player entering a scene.
     * @param param Parameters for player entry.
     */
    static void EnterScene(const EnterRoomParam& param);
     ...
     */
    static void EnterDefaultScene(const EnterDefaultRoomParam& param);

    /**
     * @brief LeaveScene handles the action of a player leaving a scene.
     * @param param Parameters for player leaving.
     */
    static void LeaveScene(const LeaveRoomParam& param);
