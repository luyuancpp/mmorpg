...
void AttributeDelta60FramesS2CSyncAttributesCore(entt::entity entity, uint32_t message_id, const PlayerContainer& targetPlayers)
{
    ...
    for (int fieldIdx = 0; fieldIdx < msgDescriptor->field_count(); ++fieldIdx)
    {
        ...
        switch (fieldNumber)
        {
        case AttributeDelta60FramesS2C::kEntityIdFieldNumber:
        {
...
// ============================================================================
// AttributeDelta60FramesS2C Attribute Sync (overload: EntityUnorderedSet)
// Purpose: Sync entity attributes for AttributeDelta60FramesS2C to an unordered player set
// Params:
...
// ============================================================================
// AttributeDelta60FramesS2C Attribute Sync (overload: EntityVector)
// Purpose: Sync entity attributes for AttributeDelta60FramesS2C to an ordered player list
// Params:
//   entity: entt entity ID identifying the target entity to sync
//   message_id: broadcast message ID for client-side message type identification
...
// ============================================================================
// SetAttributeDelta60FramesS2CAttrDirtyBit
// Purpose: Set dirty bit for a AttributeDelta60FramesS2C attribute (auto-resizes bitset)
// Params:
