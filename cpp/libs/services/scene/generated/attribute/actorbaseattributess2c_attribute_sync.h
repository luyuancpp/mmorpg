...
/**
 * @brief 脏掩码组件：用于标记ActorBaseAttributesS2C消息对应的实体属性是否需要同步
...
/**
 * @brief 同步ActorBaseAttributesS2C消息对应的实体属性到AOI范围内的玩家
...
/**
 * @brief 同步ActorBaseAttributesS2C消息对应的实体属性到指定的无序玩家集合
 * @param entity entt实体ID，标识要同步的实体
 * @param message_id 广播使用的消息ID，用于网络层识别消息类型
...
/**
 * @brief 同步ActorBaseAttributesS2C消息对应的实体属性到指定的有序玩家列表
 * @param entity entt实体ID，标识要同步的实体
 * @param message_id 广播使用的消息ID，用于网络层识别消息类型
...
/**
 * @brief 设置ActorBaseAttributesS2C消息对应属性的脏位（自动扩容bitset）
