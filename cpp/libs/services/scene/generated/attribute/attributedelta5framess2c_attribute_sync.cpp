...
// ============================================================================
// AttributeDelta5FramesS2C Attribute Sync (overload: EntityUnorderedSet)
// Purpose: Sync entity attributes for AttributeDelta5FramesS2C to an unordered player set
// Params:
...
// ============================================================================
// AttributeDelta5FramesS2C Attribute Sync (overload: EntityVector)
// Purpose: Sync entity attributes for AttributeDelta5FramesS2C to an ordered player list
// Params:
//   entity: entt entity ID identifying the target entity to sync
//   message_id: broadcast message ID for client-side message type identification
...
// Purpose: Set dirty bit for a AttributeDelta5FramesS2C attribute (auto-resizes bitset)
// Params:
