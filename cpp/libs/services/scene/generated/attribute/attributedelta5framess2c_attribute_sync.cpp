...
// ============================================================================
// AttributeDelta5FramesS2C Attribute Sync (原始版本：使用AOI列表)
...
void AttributeDelta5FramesS2CSyncAttributes(entt::entity entity, uint32_t message_id)
{
    ...
    AttributeDelta5FramesS2CSyncAttributesCore(entity, message_id, aoiListComp.aoiList);
}

// ============================================================================
// AttributeDelta5FramesS2C Attribute Sync (重载版本：EntityUnorderedSet)
// 功能：同步 AttributeDelta5FramesS2C 消息对应的实体属性到指定的无序玩家集合
// 参数：
//   entity: entt 实体ID，标识需要同步属性的目标实体
//   message_id: 网络广播使用的消息ID，用于客户端识别消息类型
...
// ============================================================================
// AttributeDelta5FramesS2C Attribute Sync (重载版本：EntityVector)
// 功能：同步 AttributeDelta5FramesS2C 消息对应的实体属性到指定的有序玩家列表
// 参数：
//   entity: entt 实体ID，标识需要同步属性的目标实体
//   message_id: 网络广播使用的消息ID，用于客户端识别消息类型
