...
// ============================================================================
// ActorBaseAttributesS2C Attribute Sync (原始版本：使用AOI列表)
// 功能：同步 ActorBaseAttributesS2C 消息对应的实体属性到AOI范围内的所有玩家
// 参数：
...
void ActorBaseAttributesS2CSyncAttributes(entt::entity entity, uint32_t message_id)
{
    ...
    ActorBaseAttributesS2CSyncAttributesCore(entity, message_id, aoiListComp.aoiList);
}
