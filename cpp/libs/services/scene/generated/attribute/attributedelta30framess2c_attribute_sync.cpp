...
// ============================================================================
// AttributeDelta30FramesS2C Attribute Sync (重载版本：EntityVector)
// 功能：同步 AttributeDelta30FramesS2C 消息对应的实体属性到指定的有序玩家列表
// 参数：
//   entity: entt 实体ID，标识需要同步属性的目标实体
//   message_id: 网络广播使用的消息ID，用于客户端识别消息类型
...
// 功能：设置 AttributeDelta30FramesS2C 消息对应属性的脏位（自动扩容bitset）
// 参数：
