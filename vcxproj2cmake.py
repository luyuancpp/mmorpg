...
generate("./region_server/region_server.vcxproj", "./lobby_server/", "")
generate("./database_server/database_server.vcxproj", "./database_server/", "")
generate("./master_server/master_server.vcxproj", "./controller_server/", "")
generate("./login_server/login_server.vcxproj", "./login_server/", "")
generate("./gateway_server/gateway_server.vcxproj", "./gate_server/", "")
