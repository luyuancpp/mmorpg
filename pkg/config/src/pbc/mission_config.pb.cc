...
static ::_pb::Metadata file_level_metadata_mission_5fconfig_2eproto[2];
...
const ::_pbi::DescriptorTable descriptor_table_mission_5fconfig_2eproto = {
    false,
    false,
    280,
    ...
    file_level_metadata_mission_5fconfig_2eproto,
...
PROTOBUF_ATTRIBUTE_WEAK const ::_pbi::DescriptorTable* descriptor_table_mission_5fconfig_2eproto_getter() {
  return &descriptor_table_mission_5fconfig_2eproto;
}
// ===================================================================
...
inline void MissionTable::SharedDtor() {
...
const char* MissionTable::_InternalParse(
...
::uint8_t* MissionTable::_InternalSerialize(
  ...
  // repeated uint32 condition_id = 2;
  {
    int byte_size = _impl_._condition_id_cached_byte_size_.Get();
    if (byte_size > 0) {
      target = stream->WriteUInt32Packed(
          2, _internal_condition_id(), byte_size, target);
    }
  }
  ...
  if (this->_internal_mission_type() != 0) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteUInt32ToArray(
        3, this->_internal_mission_type(), target);
  }

  // uint32 mission_sub_type = 4;
  if (this->_internal_mission_sub_type() != 0) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteUInt32ToArray(
        4, this->_internal_mission_sub_type(), target);
  }

  // uint32 condition_order = 5;
  if (this->_internal_condition_order() != 0) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteUInt32ToArray(
        5, this->_internal_condition_order(), target);
  }

  // uint32 auto_reward = 6;
  if (this->_internal_auto_reward() != 0) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteUInt32ToArray(
        6, this->_internal_auto_reward(), target);
  }
  ...
  if (this->_internal_reward_id() != 0) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteUInt32ToArray(
        7, this->_internal_reward_id(), target);
  }

  // repeated uint32 next_mission_id = 8;
  {
    int byte_size = _impl_._next_mission_id_cached_byte_size_.Get();
    if (byte_size > 0) {
      target = stream->WriteUInt32Packed(
          8, _internal_next_mission_id(), byte_size, target);
    }
  }
...
// @@protoc_insertion_point(message_byte_size_start:MissionTable)
  ...
  // repeated uint32 condition_id = 2;
  {
    ...
    ;
    _impl_._condition_id_cached_byte_size_.Set(::_pbi::ToCachedSize(data_size));
  ...
  {
    std::size_t data_size = ::_pbi::WireFormatLite::UInt32Size(
        this->_internal_next_mission_id())
    ;
    _impl_._next_mission_id_cached_byte_size_.Set(::_pbi::ToCachedSize(data_size));
    std::size_t tag_size = data_size == 0
        ? 0
        : 1 + ::_pbi::WireFormatLite::Int32Size(
                            static_cast<int32_t>(data_size))
  ...
  if (this->_internal_mission_sub_type() != 0) {
    total_size += ::_pbi::WireFormatLite::UInt32SizePlusOne(
        this->_internal_mission_sub_type());
  }

  // uint32 condition_order = 5;
  if (this->_internal_condition_order() != 0) {
    total_size += ::_pbi::WireFormatLite::UInt32SizePlusOne(
        this->_internal_condition_order());
  }

  // uint32 auto_reward = 6;
  if (this->_internal_auto_reward() != 0) {
    total_size += ::_pbi::WireFormatLite::UInt32SizePlusOne(
        this->_internal_auto_reward());
  }
...
PROTOBUF_NOINLINE bool MissionTable::IsInitialized() const {
  return true;
}
...
::google::protobuf::Metadata MissionTable::GetMetadata() const {
  return ::_pbi::AssignDescriptors(&descriptor_table_mission_5fconfig_2eproto_getter,
                                   &descriptor_table_mission_5fconfig_2eproto_once,
                                   file_level_metadata_mission_5fconfig_2eproto[0]);
}
// ===================================================================
...
inline void MissionTabledData::SharedDtor() {
  ABSL_DCHECK(GetArena() == nullptr);
  _impl_.~Impl_();
}
...
const char* MissionTabledData::_InternalParse(
    const char* ptr, ::_pbi::ParseContext* ctx) {
  ptr = ::_pbi::TcParser::ParseLoop(this, ptr, ctx, &_table_.header);
  return ptr;
}
...
PROTOBUF_NOINLINE bool MissionTabledData::IsInitialized() const {
  return true;
}
...
::google::protobuf::Metadata MissionTabledData::GetMetadata() const {
  return ::_pbi::AssignDescriptors(&descriptor_table_mission_5fconfig_2eproto_getter,
                                   &descriptor_table_mission_5fconfig_2eproto_once,
                                   file_level_metadata_mission_5fconfig_2eproto[1]);
}
