...
const char descriptor_table_protodef_scene_5ferror_5ftip_2eproto[] ABSL_ATTRIBUTE_SECTION_VARIABLE(
    ...
    "nd\020\032\022\026\n\022kEnterSceneNotFull\020\033\022\027\n\023kEnterSc"
    "eneMainFull\020\034\022\027\n\023kEnterGameNodeCrash\020\035\022\031"
    "\n\025kEnterSceneServerType\020\036\022\031\n\025kEnterScene"
    "ParamError\020\037\022\030\n\024kEnterSceneSceneFull\020 \022\034"
    ...
    "SceneParameters\020/\022\033\n\027kCheckEnterSceneCre"
    "ator\0200B\tZ\007pb/gameb\006proto3"
};
...
PROTOBUF_CONSTINIT const uint32_t scene_error_internal_data_[] = {
    65536u, 64u, 4261412864u, 65535u, };
bool scene_error_IsValid(int value) {
  return 0 <= value && value <= 48 && ((562949886312449u >> value) & 1) != 0;
}
