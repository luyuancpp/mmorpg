...
PROTOBUF_CONSTEXPR MonsterBaseTable::MonsterBaseTable(::_pbi::ConstantInitialized)
    ...
    : ::google::protobuf::Message(MonsterBaseTable_class_data_.base()),
...
const ::uint32_t
    TableStruct_monsterbase_5fconfig_2eproto::offsets[] ABSL_ATTRIBUTE_SECTION_VARIABLE(
        protodesc_cold) = {
        0x081, // bitmap
        PROTOBUF_FIELD_OFFSET(::MonsterBaseTable, _impl_._has_bits_),
...
class MonsterBaseTable::_Internal {
 public:
  using HasBits =
      decltype(std::declval<MonsterBaseTable>()._impl_._has_bits_);
  static constexpr ::int32_t kHasBitsOffset =
      8 * PROTOBUF_FIELD_OFFSET(MonsterBaseTable, _impl_._has_bits_);
};

MonsterBaseTable::MonsterBaseTable(::google::protobuf::Arena* PROTOBUF_NULLABLE arena)
#if defined(PROTOBUF_CUSTOM_VTABLE)
    : ::google::protobuf::Message(arena, MonsterBaseTable_class_data_.base()) {
#else   // PROTOBUF_CUSTOM_VTABLE
...
MonsterBaseTable::MonsterBaseTable(
    ::google::protobuf::Arena* PROTOBUF_NULLABLE arena, const MonsterBaseTable& from)
#if defined(PROTOBUF_CUSTOM_VTABLE)
    : ::google::protobuf::Message(arena, MonsterBaseTable_class_data_.base()),
#else   // PROTOBUF_CUSTOM_VTABLE
    : ::google::protobuf::Message(arena),
...
PROTOBUF_NDEBUG_INLINE MonsterBaseTable::Impl_::Impl_(
    ::google::protobuf::internal::InternalVisibility visibility,
    ::google::protobuf::Arena* PROTOBUF_NULLABLE arena)
      : _cached_size_{0} {}

inline void MonsterBaseTable::SharedCtor(::_pb::Arena* PROTOBUF_NULLABLE arena) {
...
inline void* PROTOBUF_NONNULL MonsterBaseTable::PlacementNew_(
...
constexpr auto MonsterBaseTable::InternalGenerateClassData_() {
...
PROTOBUF_CONSTINIT
    PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 const ::google::protobuf::internal::ClassDataFull
        MonsterBaseTable_class_data_ =
            MonsterBaseTable::InternalGenerateClassData_();

const ::google::protobuf::internal::ClassData* PROTOBUF_NONNULL MonsterBaseTable::GetClassData() const {
  ::google::protobuf::internal::PrefetchToLocalCache(&MonsterBaseTable_class_data_);
  ::google::protobuf::internal::PrefetchToLocalCache(MonsterBaseTable_class_data_.tc_table);
  return MonsterBaseTable_class_data_.base();
}
PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1
const ::_pbi::TcParseTable<0, 1, 0, 0, 2>
MonsterBaseTable::_table_ = {
  {
    PROTOBUF_FIELD_OFFSET(MonsterBaseTable, _impl_._has_bits_),
    0, // no _extensions_
    ...
    MonsterBaseTable_class_data_.base(),
    ...
    // uint32 id = 1;
    {::_pbi::TcParser::SingularVarintNoZag1<::uint32_t, offsetof(MonsterBaseTable, _impl_.id_), 0>(),
     {8, 0, 0, PROTOBUF_FIELD_OFFSET(MonsterBaseTable, _impl_.id_)}},
  }}, {{
    65535, 65535
  }}, {{
    // uint32 id = 1;
    {PROTOBUF_FIELD_OFFSET(MonsterBaseTable, _impl_.id_), _Internal::kHasBitsOffset + 0, 0,
...
#if defined(PROTOBUF_CUSTOM_VTABLE)
::uint8_t* PROTOBUF_NONNULL MonsterBaseTable::_InternalSerialize(
...
void MonsterBaseTable::InternalSwap(MonsterBaseTable* PROTOBUF_RESTRICT PROTOBUF_NONNULL other) {
  using std::swap;
...
PROTOBUF_CONSTINIT
    PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 const ::google::protobuf::internal::ClassDataFull
        MonsterBaseTabledData_class_data_ =
            MonsterBaseTabledData::InternalGenerateClassData_();

const ::google::protobuf::internal::ClassData* PROTOBUF_NONNULL MonsterBaseTabledData::GetClassData() const {
