...
extern "C" {
extern const ::google::protobuf::internal::DescriptorTable descriptor_table_monsterbase_5fconfig_2eproto;
}  // extern "C"
...
/* @@protoc_insertion_point(class_definition:MonsterBaseTable) */ {
 public:
  ...
  void operator delete(MonsterBaseTable* PROTOBUF_NONNULL msg, std::destroying_delete_t) {
    SharedDtor(*msg);
  ...
  explicit PROTOBUF_CONSTEXPR MonsterBaseTable(::google::protobuf::internal::ConstantInitialized);
  ...
  inline void Swap(MonsterBaseTable* PROTOBUF_NONNULL other) {
  ...
  void UnsafeArenaSwap(MonsterBaseTable* PROTOBUF_NONNULL other) {
    if (other == this) return;
  ...
  MonsterBaseTable* PROTOBUF_NONNULL New(::google::protobuf::Arena* PROTOBUF_NULLABLE arena = nullptr) const {
  ...
  void InternalSwap(MonsterBaseTable* PROTOBUF_NONNULL other);
 private:
  template <typename T>
 ...
 protected:
  explicit MonsterBaseTable(::google::protobuf::Arena* PROTOBUF_NULLABLE arena);
  MonsterBaseTable(::google::protobuf::Arena* PROTOBUF_NULLABLE arena, const MonsterBaseTable& from);
  MonsterBaseTable(
      ::google::protobuf::Arena* PROTOBUF_NULLABLE arena, MonsterBaseTable&& from) noexcept
...
/* @@protoc_insertion_point(class_definition:MonsterBaseTabledData) */ {
 ...
 public:
  ...
  public:
  void clear_data() ;
  ::MonsterBaseTable* PROTOBUF_NONNULL mutable_data(int index);
  ::google::protobuf::RepeatedPtrField<::MonsterBaseTable>* PROTOBUF_NONNULL mutable_data();

  private:
  const ::google::protobuf::RepeatedPtrField<::MonsterBaseTable>& _internal_data() const;
  ::google::protobuf::RepeatedPtrField<::MonsterBaseTable>* PROTOBUF_NONNULL _internal_mutable_data();
  public:
