...
extern "C" {
extern const ::google::protobuf::internal::DescriptorTable descriptor_table_item_5fconfig_2eproto;
}  // extern "C"
class ItemTable;
...
/* @@protoc_insertion_point(class_definition:ItemTable) */ {
 public:
  ...
  explicit PROTOBUF_CONSTEXPR ItemTable(::google::protobuf::internal::ConstantInitialized);
  ...
  ItemTable* PROTOBUF_NONNULL New(::google::protobuf::Arena* PROTOBUF_NULLABLE arena = nullptr) const {
...
/* @@protoc_insertion_point(class_definition:ItemTabledData) */ {
 ...
 public:
  ...
  public:
  void clear_data() ;
  ::ItemTable* PROTOBUF_NONNULL mutable_data(int index);
  ::google::protobuf::RepeatedPtrField<::ItemTable>* PROTOBUF_NONNULL mutable_data();
