...
PROTOBUF_ATTRIBUTE_WEAK const ::_pbi::DescriptorTable* descriptor_table_proto_2flogic_2fconstants_2fnode_2eproto_getter() {
  return &descriptor_table_proto_2flogic_2fconstants_2fnode_2eproto;
}
