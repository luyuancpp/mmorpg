...
#ifndef proto_2flogic_2fcomponent_2fplayer_5fskill_5fcomp_2eproto_2epb_2eh
#define proto_2flogic_2fcomponent_2fplayer_5fskill_5fcomp_2eproto_2epb_2eh
...
class PlayerSkillPBComponent final
...
/* @@protoc_insertion_point(class_definition:PlayerSkillPBComponent) */ {
 public:
  ...
  void operator delete(PlayerSkillPBComponent* msg, std::destroying_delete_t) {
    SharedDtor(*msg);
  ...
  PlayerSkillPBComponent* New(::google::protobuf::Arena* arena = nullptr) const {
...
class PlayerSkillListPBComponent final
    : public ::google::protobuf::Message
/* @@protoc_insertion_point(class_definition:PlayerSkillListPBComponent) */ {
 public:
...
#if defined(PROTOBUF_CUSTOM_VTABLE)
  void operator delete(PlayerSkillListPBComponent* msg, std::destroying_delete_t) {
    SharedDtor(*msg);
  ...
  PlayerSkillListPBComponent* New(::google::protobuf::Arena* arena = nullptr) const {
...
#endif  // proto_2flogic_2fcomponent_2fplayer_5fskill_5fcomp_2eproto_2epb_2eh
