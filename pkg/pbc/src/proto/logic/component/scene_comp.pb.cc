...
static constexpr const ::_pb::ServiceDescriptor**
    file_level_service_descriptors_logic_2fcomponent_2fscene_5fcomp_2eproto = nullptr;
const ::uint32_t
...
const ::_pbi::DescriptorTable descriptor_table_logic_2fcomponent_2fscene_5fcomp_2eproto = {
    ...
    TableStruct_logic_2fcomponent_2fscene_5fcomp_2eproto::offsets,
    file_level_metadata_logic_2fcomponent_2fscene_5fcomp_2eproto,
    file_level_enum_descriptors_logic_2fcomponent_2fscene_5fcomp_2eproto,
    file_level_service_descriptors_logic_2fcomponent_2fscene_5fcomp_2eproto,
};
...
::uint8_t* ChangeSceneInfoPBComponent::_InternalSerialize(
  ...
  if (this->_internal_dungen_confid() != 0) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteUInt32ToArray(
        3, this->_internal_dungen_confid(), target);
  }
  ...
  if (this->_internal_mirror_confid() != 0) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteUInt32ToArray(
        4, this->_internal_mirror_confid(), target);
  }

  // uint32 change_sequence = 5;
  if (this->_internal_change_sequence() != 0) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteUInt32ToArray(
        5, this->_internal_change_sequence(), target);
  }

  // uint32 change_gs_type = 6;
  if (this->_internal_change_gs_type() != 0) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteUInt32ToArray(
        6, this->_internal_change_gs_type(), target);
  }

  // uint32 change_gs_status = 7;
  if (this->_internal_change_gs_status() != 0) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteUInt32ToArray(
        7, this->_internal_change_gs_status(), target);
  }
  ...
  if (this->_internal_change_time() != 0) {
    ...
    target = ::_pbi::WireFormatLite::WriteUInt64ToArray(
        8, this->_internal_change_time(), target);
  }

  // bool ignore_full = 9;
  if (this->_internal_ignore_full() != 0) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteBoolToArray(
        9, this->_internal_ignore_full(), target);
  }
  ...
  if (this->_internal_processing() != 0) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteBoolToArray(
        10, this->_internal_processing(), target);
  }
...
// @@protoc_insertion_point(message_byte_size_start:ChangeSceneInfoPBComponent)
  ...
  if (this->_internal_change_sequence() != 0) {
    total_size += ::_pbi::WireFormatLite::UInt32SizePlusOne(
        this->_internal_change_sequence());
  }

  // uint32 change_gs_type = 6;
  if (this->_internal_change_gs_type() != 0) {
    total_size += ::_pbi::WireFormatLite::UInt32SizePlusOne(
        this->_internal_change_gs_type());
  }

  // uint64 change_time = 8;
  if (this->_internal_change_time() != 0) {
    total_size += ::_pbi::WireFormatLite::UInt64SizePlusOne(
        this->_internal_change_time());
  }

  // uint32 change_gs_status = 7;
  if (this->_internal_change_gs_status() != 0) {
    total_size += ::_pbi::WireFormatLite::UInt32SizePlusOne(
        this->_internal_change_gs_status());
  }
...
static ::std::false_type _static_init_ PROTOBUF_UNUSED =
    (::_pbi::AddDescriptors(&descriptor_table_logic_2fcomponent_2fscene_5fcomp_2eproto),
     ::std::false_type{});
