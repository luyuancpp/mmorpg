...
static ::_pb::Metadata file_level_metadata_logic_2fcomponent_2fframe_5fcomp_2eproto[1];
static constexpr const ::_pb::EnumDescriptor**
    file_level_enum_descriptors_logic_2fcomponent_2fframe_5fcomp_2eproto = nullptr;
static constexpr const ::_pb::ServiceDescriptor**
    file_level_service_descriptors_logic_2fcomponent_2fframe_5fcomp_2eproto = nullptr;
const ::uint32_t
    TableStruct_logic_2fcomponent_2fframe_5fcomp_2eproto::offsets[] ABSL_ATTRIBUTE_SECTION_VARIABLE(
        protodesc_cold) = {
        ~0u,  // no _has_bits_
...
const ::_pbi::DescriptorTable descriptor_table_logic_2fcomponent_2fframe_5fcomp_2eproto = {
    ...
    TableStruct_logic_2fcomponent_2fframe_5fcomp_2eproto::offsets,
    file_level_metadata_logic_2fcomponent_2fframe_5fcomp_2eproto,
    file_level_enum_descriptors_logic_2fcomponent_2fframe_5fcomp_2eproto,
    file_level_service_descriptors_logic_2fcomponent_2fframe_5fcomp_2eproto,
};
...
PROTOBUF_ATTRIBUTE_WEAK const ::_pbi::DescriptorTable* descriptor_table_logic_2fcomponent_2fframe_5fcomp_2eproto_getter() {
  return &descriptor_table_logic_2fcomponent_2fframe_5fcomp_2eproto;
}
// ===================================================================
...
inline void FrameTime::SharedDtor() {
...
const char* FrameTime::_InternalParse(
...
::uint8_t* FrameTime::_InternalSerialize(
  ...
  // uint64 previous_time = 1;
  if (this->_internal_previous_time() != 0) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteUInt64ToArray(
        1, this->_internal_previous_time(), target);
  }

  // double delta_time = 2;
  static_assert(sizeof(::uint64_t) == sizeof(double),
                "Code assumes ::uint64_t and double are the same size.");
  double tmp_delta_time = this->_internal_delta_time();
  ::uint64_t raw_delta_time;
  memcpy(&raw_delta_time, &tmp_delta_time, sizeof(tmp_delta_time));
  if (raw_delta_time != 0) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteDoubleToArray(
        2, this->_internal_delta_time(), target);
  }
  ...
  if (this->_internal_target_fps() != 0) {
    ...
    target = ::_pbi::WireFormatLite::WriteUInt32ToArray(
        3, this->_internal_target_fps(), target);
  }

  // double time_accumulator = 4;
  static_assert(sizeof(::uint64_t) == sizeof(double),
                "Code assumes ::uint64_t and double are the same size.");
  double tmp_time_accumulator = this->_internal_time_accumulator();
  ::uint64_t raw_time_accumulator;
...
void FrameTime::MergeImpl(::google::protobuf::MessageLite& to_msg, const ::google::protobuf::MessageLite& from_msg) {
  ...
  static_assert(sizeof(::uint64_t) == sizeof(double),
                "Code assumes ::uint64_t and double are the same size.");
  double tmp_delta_time = from._internal_delta_time();
  ::uint64_t raw_delta_time;
  memcpy(&raw_delta_time, &tmp_delta_time, sizeof(tmp_delta_time));
  if (raw_delta_time != 0) {
  ...
  static_assert(sizeof(::uint64_t) == sizeof(double),
                "Code assumes ::uint64_t and double are the same size.");
  double tmp_time_accumulator = from._internal_time_accumulator();
  ::uint64_t raw_time_accumulator;
  memcpy(&raw_time_accumulator, &tmp_time_accumulator, sizeof(tmp_time_accumulator));
  if (raw_time_accumulator != 0) {
...
PROTOBUF_NOINLINE bool FrameTime::IsInitialized() const {
  return true;
}
...
::google::protobuf::Metadata FrameTime::GetMetadata() const {
  return ::_pbi::AssignDescriptors(&descriptor_table_logic_2fcomponent_2fframe_5fcomp_2eproto_getter,
                                   &descriptor_table_logic_2fcomponent_2fframe_5fcomp_2eproto_once,
                                   file_level_metadata_logic_2fcomponent_2fframe_5fcomp_2eproto[0]);
}
...
static ::std::false_type _static_init_ PROTOBUF_UNUSED =
    (::_pbi::AddDescriptors(&descriptor_table_logic_2fcomponent_2fframe_5fcomp_2eproto),
     ::std::false_type{});
