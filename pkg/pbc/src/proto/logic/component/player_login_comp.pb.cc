...
PROTOBUF_CONSTEXPR EnterGameNodeInfoPBComponent::EnterGameNodeInfoPBComponent(::_pbi::ConstantInitialized)
    ...
    : ::google::protobuf::Message(EnterGameNodeInfoPBComponent_class_data_.base()),
...
const ::uint32_t
    TableStruct_proto_2flogic_2fcomponent_2fplayer_5flogin_5fcomp_2eproto::offsets[] ABSL_ATTRIBUTE_SECTION_VARIABLE(
        protodesc_cold) = {
        0x081, // bitmap
        PROTOBUF_FIELD_OFFSET(::EnterGameNodeInfoPBComponent, _impl_._has_bits_),
...
static const ::_pbi::MigrationSchema
    schemas[] ABSL_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
        {0, sizeof(::EnterGameNodeInfoPBComponent)},
};
...
class EnterGameNodeInfoPBComponent::_Internal {
 public:
  using HasBits =
      decltype(std::declval<EnterGameNodeInfoPBComponent>()._impl_._has_bits_);
  static constexpr ::int32_t kHasBitsOffset =
      8 * PROTOBUF_FIELD_OFFSET(EnterGameNodeInfoPBComponent, _impl_._has_bits_);
};

EnterGameNodeInfoPBComponent::EnterGameNodeInfoPBComponent(::google::protobuf::Arena* PROTOBUF_NULLABLE arena)
#if defined(PROTOBUF_CUSTOM_VTABLE)
    : ::google::protobuf::Message(arena, EnterGameNodeInfoPBComponent_class_data_.base()) {
#else   // PROTOBUF_CUSTOM_VTABLE
...
EnterGameNodeInfoPBComponent::EnterGameNodeInfoPBComponent(
    ::google::protobuf::Arena* PROTOBUF_NULLABLE arena, const EnterGameNodeInfoPBComponent& from)
#if defined(PROTOBUF_CUSTOM_VTABLE)
    : ::google::protobuf::Message(arena, EnterGameNodeInfoPBComponent_class_data_.base()),
#else   // PROTOBUF_CUSTOM_VTABLE
    : ::google::protobuf::Message(arena),
...
PROTOBUF_NDEBUG_INLINE EnterGameNodeInfoPBComponent::Impl_::Impl_(
    ::google::protobuf::internal::InternalVisibility visibility,
    ::google::protobuf::Arena* PROTOBUF_NULLABLE arena)
      : _cached_size_{0} {}

inline void EnterGameNodeInfoPBComponent::SharedCtor(::_pb::Arena* PROTOBUF_NULLABLE arena) {
...
inline void* PROTOBUF_NONNULL EnterGameNodeInfoPBComponent::PlacementNew_(
...
constexpr auto EnterGameNodeInfoPBComponent::InternalGenerateClassData_() {
...
PROTOBUF_CONSTINIT
    PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 const ::google::protobuf::internal::ClassDataFull
        EnterGameNodeInfoPBComponent_class_data_ =
            EnterGameNodeInfoPBComponent::InternalGenerateClassData_();

const ::google::protobuf::internal::ClassData* PROTOBUF_NONNULL EnterGameNodeInfoPBComponent::GetClassData() const {
  ::google::protobuf::internal::PrefetchToLocalCache(&EnterGameNodeInfoPBComponent_class_data_);
  ::google::protobuf::internal::PrefetchToLocalCache(EnterGameNodeInfoPBComponent_class_data_.tc_table);
  return EnterGameNodeInfoPBComponent_class_data_.base();
}
PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1
const ::_pbi::TcParseTable<0, 1, 0, 0, 2>
EnterGameNodeInfoPBComponent::_table_ = {
  {
    PROTOBUF_FIELD_OFFSET(EnterGameNodeInfoPBComponent, _impl_._has_bits_),
    0, // no _extensions_
    ...
    EnterGameNodeInfoPBComponent_class_data_.base(),
    ...
    {::_pbi::TcParser::SingularVarintNoZag1<::uint32_t, offsetof(EnterGameNodeInfoPBComponent, _impl_.enter_gs_type_), 0>(),
     {8, 0, 0, PROTOBUF_FIELD_OFFSET(EnterGameNodeInfoPBComponent, _impl_.enter_gs_type_)}},
  }}, {{
    65535, 65535
  }}, {{
    // uint32 enter_gs_type = 1;
    {PROTOBUF_FIELD_OFFSET(EnterGameNodeInfoPBComponent, _impl_.enter_gs_type_), _Internal::kHasBitsOffset + 0, 0,
...
#if defined(PROTOBUF_CUSTOM_VTABLE)
::uint8_t* PROTOBUF_NONNULL EnterGameNodeInfoPBComponent::_InternalSerialize(
...
void EnterGameNodeInfoPBComponent::InternalSwap(EnterGameNodeInfoPBComponent* PROTOBUF_RESTRICT PROTOBUF_NONNULL other) {
  using std::swap;
