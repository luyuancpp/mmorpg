...
PROTOBUF_CONSTEXPR Npc::Npc(::_pbi::ConstantInitialized)
    ...
    : ::google::protobuf::internal::ZeroFieldsBase(Npc_class_data_.base()){}
...
#if defined(PROTOBUF_CUSTOM_VTABLE)
    : ::google::protobuf::internal::ZeroFieldsBase(arena, Npc_class_data_.base()) {
#else   // PROTOBUF_CUSTOM_VTABLE
...
const ::google::protobuf::internal::ClassData* PROTOBUF_NONNULL Npc::GetClassData() const {
