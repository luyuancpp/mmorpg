...
class InitializeNpcComponentsEvent final
...
/* @@protoc_insertion_point(class_definition:InitializeNpcComponentsEvent) */ {
 public:
  ...
  void operator delete(InitializeNpcComponentsEvent* msg, std::destroying_delete_t) {
    SharedDtor(*msg);
  ...
  InitializeNpcComponentsEvent* New(::google::protobuf::Arena* arena = nullptr) const {
