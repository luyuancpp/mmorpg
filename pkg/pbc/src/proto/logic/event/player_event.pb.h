...
class RegisterPlayerEvent final
...
/* @@protoc_insertion_point(class_definition:RegisterPlayerEvent) */ {
 public:
  ...
  void operator delete(RegisterPlayerEvent* msg, std::destroying_delete_t) {
    SharedDtor(*msg);
  ...
  RegisterPlayerEvent* New(::google::protobuf::Arena* arena = nullptr) const {
...
class PlayerUpgradeEvent final
    : public ::google::protobuf::Message
/* @@protoc_insertion_point(class_definition:PlayerUpgradeEvent) */ {
 public:
...
#if defined(PROTOBUF_CUSTOM_VTABLE)
  void operator delete(PlayerUpgradeEvent* msg, std::destroying_delete_t) {
    SharedDtor(*msg);
  ...
  PlayerUpgradeEvent* New(::google::protobuf::Arena* arena = nullptr) const {
...
class InitializePlayerComponentsEvent final
    : public ::google::protobuf::Message
/* @@protoc_insertion_point(class_definition:InitializePlayerComponentsEvent) */ {
 public:
...
#if defined(PROTOBUF_CUSTOM_VTABLE)
  void operator delete(InitializePlayerComponentsEvent* msg, std::destroying_delete_t) {
    SharedDtor(*msg);
  ...
  InitializePlayerComponentsEvent* New(::google::protobuf::Arena* arena = nullptr) const {
