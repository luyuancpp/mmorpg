...
static constexpr const ::_pb::ServiceDescriptor**
    file_level_service_descriptors_proto_2fplayerlocator_2fplayerlocator_2eproto = nullptr;
const ::uint32_t
    TableStruct_proto_2fplayerlocator_2fplayerlocator_2eproto::offsets[] ABSL_ATTRIBUTE_SECTION_VARIABLE(
        protodesc_cold) = {
        ~0u,  // no _has_bits_
...
PROTOBUF_CONSTINIT const ::_pbi::DescriptorTable descriptor_table_proto_2fplayerlocator_2fplayerlocator_2eproto = {
    ...
    file_level_enum_descriptors_proto_2fplayerlocator_2fplayerlocator_2eproto,
    file_level_service_descriptors_proto_2fplayerlocator_2fplayerlocator_2eproto,
};
namespace playerlocator {
// ===================================================================
...
PROTOBUF_ATTRIBUTE_INIT_PRIORITY2 static ::std::false_type
    _static_init2_ PROTOBUF_UNUSED =
        (::_pbi::AddDescriptors(&descriptor_table_proto_2fplayerlocator_2fplayerlocator_2eproto),
         ::std::false_type{});
