...
::grpc::Status PlayerLocator::Stub::SetLocation(::grpc::ClientContext* context, const ::playerlocator::PlayerLocation& request, ::playerlocator::Empty* response) {
  return ::grpc::internal::BlockingUnaryCall< ::playerlocator::PlayerLocation, ::playerlocator::Empty, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(channel_.get(), rpcmethod_SetLocation_, context, request, response);
}

void PlayerLocator::Stub::async::SetLocation(::grpc::ClientContext* context, const ::playerlocator::PlayerLocation* request, ::playerlocator::Empty* response, std::function<void(::grpc::Status)> f) {
  ::grpc::internal::CallbackUnaryCall< ::playerlocator::PlayerLocation, ::playerlocator::Empty, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(stub_->channel_.get(), stub_->rpcmethod_SetLocation_, context, request, response, std::move(f));
}

void PlayerLocator::Stub::async::SetLocation(::grpc::ClientContext* context, const ::playerlocator::PlayerLocation* request, ::playerlocator::Empty* response, ::grpc::ClientUnaryReactor* reactor) {
...
::grpc::ClientAsyncResponseReader< ::playerlocator::Empty>* PlayerLocator::Stub::PrepareAsyncSetLocationRaw(::grpc::ClientContext* context, const ::playerlocator::PlayerLocation& request, ::grpc::CompletionQueue* cq) {
  return ::grpc::internal::ClientAsyncResponseReaderHelper::Create< ::playerlocator::Empty, ::playerlocator::PlayerLocation, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(channel_.get(), cq, rpcmethod_SetLocation_, context, request);
}

::grpc::ClientAsyncResponseReader< ::playerlocator::Empty>* PlayerLocator::Stub::AsyncSetLocationRaw(::grpc::ClientContext* context, const ::playerlocator::PlayerLocation& request, ::grpc::CompletionQueue* cq) {
  auto* result =
...
::grpc::Status PlayerLocator::Stub::MarkOffline(::grpc::ClientContext* context, const ::playerlocator::PlayerId& request, ::playerlocator::Empty* response) {
  return ::grpc::internal::BlockingUnaryCall< ::playerlocator::PlayerId, ::playerlocator::Empty, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(channel_.get(), rpcmethod_MarkOffline_, context, request, response);
}

void PlayerLocator::Stub::async::MarkOffline(::grpc::ClientContext* context, const ::playerlocator::PlayerId* request, ::playerlocator::Empty* response, std::function<void(::grpc::Status)> f) {
  ::grpc::internal::CallbackUnaryCall< ::playerlocator::PlayerId, ::playerlocator::Empty, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(stub_->channel_.get(), stub_->rpcmethod_MarkOffline_, context, request, response, std::move(f));
}

void PlayerLocator::Stub::async::MarkOffline(::grpc::ClientContext* context, const ::playerlocator::PlayerId* request, ::playerlocator::Empty* response, ::grpc::ClientUnaryReactor* reactor) {
...
::grpc::ClientAsyncResponseReader< ::playerlocator::Empty>* PlayerLocator::Stub::PrepareAsyncMarkOfflineRaw(::grpc::ClientContext* context, const ::playerlocator::PlayerId& request, ::grpc::CompletionQueue* cq) {
  return ::grpc::internal::ClientAsyncResponseReaderHelper::Create< ::playerlocator::Empty, ::playerlocator::PlayerId, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(channel_.get(), cq, rpcmethod_MarkOffline_, context, request);
}

::grpc::ClientAsyncResponseReader< ::playerlocator::Empty>* PlayerLocator::Stub::AsyncMarkOfflineRaw(::grpc::ClientContext* context, const ::playerlocator::PlayerId& request, ::grpc::CompletionQueue* cq) {
  auto* result =
...
PlayerLocator::Service::Service() {
  AddMethod(new ::grpc::internal::RpcServiceMethod(
      ...
      new ::grpc::internal::RpcMethodHandler< PlayerLocator::Service, ::playerlocator::PlayerLocation, ::playerlocator::Empty, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(
          [](PlayerLocator::Service* service,
             ::grpc::ServerContext* ctx,
             const ::playerlocator::PlayerLocation* req,
             ::playerlocator::Empty* resp) {
  ...
  AddMethod(new ::grpc::internal::RpcServiceMethod(
      ...
      ::grpc::internal::RpcMethod::NORMAL_RPC,
      new ::grpc::internal::RpcMethodHandler< PlayerLocator::Service, ::playerlocator::PlayerId, ::playerlocator::Empty, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(
          [](PlayerLocator::Service* service,
             ::grpc::ServerContext* ctx,
             const ::playerlocator::PlayerId* req,
             ::playerlocator::Empty* resp) {
...
::grpc::Status PlayerLocator::Service::SetLocation(::grpc::ServerContext* context, const ::playerlocator::PlayerLocation* request, ::playerlocator::Empty* response) {
  (void) context;
  (void) request;
  (void) response;
...
::grpc::Status PlayerLocator::Service::MarkOffline(::grpc::ServerContext* context, const ::playerlocator::PlayerId* request, ::playerlocator::Empty* response) {
  (void) context;
  (void) request;
  (void) response;
  return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
