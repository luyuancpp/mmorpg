...
class AccountSimplePlayer final
...
/* @@protoc_insertion_point(class_definition:AccountSimplePlayer) */ {
 public:
  ...
  void operator delete(AccountSimplePlayer* msg, std::destroying_delete_t) {
    SharedDtor(*msg);
  ...
  AccountSimplePlayer* New(::google::protobuf::Arena* arena = nullptr) const {
...
class AccountSimplePlayerList final
    : public ::google::protobuf::Message
/* @@protoc_insertion_point(class_definition:AccountSimplePlayerList) */ {
 public:
...
#if defined(PROTOBUF_CUSTOM_VTABLE)
  void operator delete(AccountSimplePlayerList* msg, std::destroying_delete_t) {
    SharedDtor(*msg);
  ...
  AccountSimplePlayerList* New(::google::protobuf::Arena* arena = nullptr) const {
