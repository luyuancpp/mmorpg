...
PROTOBUF_CONSTEXPR MessageStatistics::MessageStatistics(::_pbi::ConstantInitialized)
    ...
    : ::google::protobuf::Message(MessageStatistics_class_data_.base()),
...
class MessageStatistics::_Internal {
 public:
  using HasBits =
      decltype(std::declval<MessageStatistics>()._impl_._has_bits_);
...
#if defined(PROTOBUF_CUSTOM_VTABLE)
    : ::google::protobuf::Message(arena, MessageStatistics_class_data_.base()) {
#else   // PROTOBUF_CUSTOM_VTABLE
...
PROTOBUF_CONSTINIT
    PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 const ::google::protobuf::internal::ClassDataFull
        MessageStatistics_class_data_ =
            MessageStatistics::InternalGenerateClassData_();

const ::google::protobuf::internal::ClassData* PROTOBUF_NONNULL MessageStatistics::GetClassData() const {
...
MessageStatistics::_table_ = {
  {
    ...
    {::_pbi::TcParser::SingularVarintNoZag1<::uint32_t, offsetof(MessageStatistics, _impl_.second_), 3>(),
     {32, 3, 0, PROTOBUF_FIELD_OFFSET(MessageStatistics, _impl_.second_)}},
    // uint32 count = 1;
    {::_pbi::TcParser::SingularVarintNoZag1<::uint32_t, offsetof(MessageStatistics, _impl_.count_), 0>(),
     {8, 0, 0, PROTOBUF_FIELD_OFFSET(MessageStatistics, _impl_.count_)}},
    ...
    {::_pbi::TcParser::SingularVarintNoZag1<::uint32_t, offsetof(MessageStatistics, _impl_.flow_rate_second_), 1>(),
     {16, 1, 0, PROTOBUF_FIELD_OFFSET(MessageStatistics, _impl_.flow_rate_second_)}},
    // uint64 flow_rate_total = 3;
    {::_pbi::TcParser::SingularVarintNoZag1<::uint64_t, offsetof(MessageStatistics, _impl_.flow_rate_total_), 2>(),
     {24, 2, 0, PROTOBUF_FIELD_OFFSET(MessageStatistics, _impl_.flow_rate_total_)}},
  }}, {{
    65535, 65535
  }}, {{
    // uint32 count = 1;
    {PROTOBUF_FIELD_OFFSET(MessageStatistics, _impl_.count_), _Internal::kHasBitsOffset + 0, 0,
    (0 | ::_fl::kFcOptional | ::_fl::kUInt32)},
    // uint32 flow_rate_second = 2;
    {PROTOBUF_FIELD_OFFSET(MessageStatistics, _impl_.flow_rate_second_), _Internal::kHasBitsOffset + 1, 0,
    (0 | ::_fl::kFcOptional | ::_fl::kUInt32)},
    // uint64 flow_rate_total = 3;
    {PROTOBUF_FIELD_OFFSET(MessageStatistics, _impl_.flow_rate_total_), _Internal::kHasBitsOffset + 2, 0,
    (0 | ::_fl::kFcOptional | ::_fl::kUInt64)},
    // uint32 second = 4;
    {PROTOBUF_FIELD_OFFSET(MessageStatistics, _impl_.second_), _Internal::kHasBitsOffset + 3, 0,
    (0 | ::_fl::kFcOptional | ::_fl::kUInt32)},
  }},
  // no aux_entries
  {{
