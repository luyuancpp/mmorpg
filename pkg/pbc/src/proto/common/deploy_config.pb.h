...
/* @@protoc_insertion_point(class_definition:GameConfigInfo) */ {
 public:
  ...
  void operator delete(GameConfigInfo* msg, std::destroying_delete_t) {
    SharedDtor(*msg);
  ...
  GameConfigInfo* New(::google::protobuf::Arena* arena = nullptr) const {
...
/* @@protoc_insertion_point(class_definition:ConnetionParam) */ {
 public:
...
#if defined(PROTOBUF_CUSTOM_VTABLE)
  void operator delete(ConnetionParam* msg, std::destroying_delete_t) {
    SharedDtor(*msg);
  ...
  ConnetionParam* New(::google::protobuf::Arena* arena = nullptr) const {
...
inline std::string* GameConfigInfo::add_mq_topics() ABSL_ATTRIBUTE_LIFETIME_BOUND {
  ::google::protobuf::internal::TSanWrite(&_impl_);
...
inline void GameConfigInfo::set_mq_topics(int index, Arg_&& value, Args_... args) {
  ::google::protobuf::internal::AssignToString(
      *_internal_mutable_mq_topics()->Mutable(index),
