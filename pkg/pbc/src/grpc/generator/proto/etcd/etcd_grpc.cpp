...
void InitetcdserverpbWatchCompletedQueue(entt::registry& registry, entt::entity nodeEntity) {
...

	{
		...
		client.stream =
			...
			&registry.get<etcdserverpbWatchWatchCompleteQueue>(nodeEntity).cq, (void*)(GrpcTag::INIT));
	}
...
void InitetcdserverpbLeaseCompletedQueue(entt::registry& registry, entt::entity nodeEntity) {
...

	{
		...
		client.stream =
			...
			&registry.get<etcdserverpbLeaseLeaseKeepAliveCompleteQueue>(nodeEntity).cq, (void*)(GrpcTag::INIT));
	}
