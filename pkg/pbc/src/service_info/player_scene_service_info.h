...
constexpr uint32_t ClientPlayerSceneServiceEnterSceneMessageId = 0;
...
constexpr uint32_t ClientPlayerSceneServiceNotifyEnterSceneMessageId = 78;
...
constexpr uint32_t ClientPlayerSceneServiceSceneInfoC2SMessageId = 76;
...
constexpr uint32_t ClientPlayerSceneServiceNotifyActorDestroyMessageId = 71;
...
constexpr uint32_t ClientPlayerSceneServiceNotifyActorListCreateMessageId = 21;
...
constexpr uint32_t ClientPlayerSceneServiceNotifyActorListDestroyMessageId = 33;
