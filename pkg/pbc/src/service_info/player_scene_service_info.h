...
constexpr uint32_t ClientPlayerSceneServiceEnterSceneMessageId = 62;
...
constexpr uint32_t ClientPlayerSceneServiceNotifyEnterSceneMessageId = 22;
...
constexpr uint32_t ClientPlayerSceneServiceSceneInfoC2SMessageId = 63;
...
constexpr uint32_t ClientPlayerSceneServiceNotifySceneInfoMessageId = 47;
...
constexpr uint32_t ClientPlayerSceneServiceNotifyActorCreateMessageId = 82;
...
constexpr uint32_t ClientPlayerSceneServiceNotifyActorDestroyMessageId = 24;
...
constexpr uint32_t ClientPlayerSceneServiceNotifyActorListDestroyMessageId = 35;
