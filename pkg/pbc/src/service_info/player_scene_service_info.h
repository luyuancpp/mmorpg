...
constexpr uint32_t ClientPlayerSceneServiceEnterSceneMessageId = 21;
...
constexpr uint32_t ClientPlayerSceneServiceNotifyEnterSceneMessageId = 30;
...
constexpr uint32_t ClientPlayerSceneServiceSceneInfoC2SMessageId = 48;
...
constexpr uint32_t ClientPlayerSceneServiceNotifySceneInfoMessageId = 67;
...
constexpr uint32_t ClientPlayerSceneServiceNotifyActorCreateMessageId = 37;
...
constexpr uint32_t ClientPlayerSceneServiceNotifyActorDestroyMessageId = 72;
...
constexpr uint32_t ClientPlayerSceneServiceNotifyActorListCreateMessageId = 8;
...
constexpr uint32_t ClientPlayerSceneServiceNotifyActorListDestroyMessageId = 26;
