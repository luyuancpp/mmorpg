...
constexpr uint32_t GameServicePlayerEnterGameNodeMessageId = 22;
...
constexpr uint32_t GameServiceSendMessageToPlayerMessageId = 14;
...
constexpr uint32_t GameServiceClientSendMessageToPlayerMessageId = 59;
...
constexpr uint32_t GameServiceInvokePlayerServiceMessageId = 16;
...
constexpr uint32_t GameServiceRouteNodeStringMsgMessageId = 12;
...
constexpr uint32_t GameServiceRoutePlayerStringMsgMessageId = 38;
...
constexpr uint32_t GameServiceUpdateSessionDetailMessageId = 56;
...
constexpr uint32_t GameServiceEnterSceneMessageId = 53;
...
constexpr uint32_t GameServiceRegisterNodeSessionMessageId = 42;
