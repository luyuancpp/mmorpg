...
constexpr uint32_t GameServicePlayerEnterGameNodeMessageId = 42;
...
constexpr uint32_t GameServiceSendMessageToPlayerMessageId = 32;
...
constexpr uint32_t GameServiceClientSendMessageToPlayerMessageId = 44;
...
constexpr uint32_t GameServiceCentreSendToPlayerViaGameNodeMessageId = 64;
...
constexpr uint32_t GameServiceInvokePlayerServiceMessageId = 25;
...
constexpr uint32_t GameServiceRouteNodeStringMsgMessageId = 35;
...
constexpr uint32_t GameServiceRoutePlayerStringMsgMessageId = 24;
...
constexpr uint32_t GameServiceUpdateSessionDetailMessageId = 66;
