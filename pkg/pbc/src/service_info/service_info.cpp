...
{
    gRpcServiceRegistry[PlayerLocatorSetLocationMessageId] = RpcService{"PlayerLocator", "SetLocation", std::make_unique_for_overwrite<::playerlocator::PlayerLocation>(), std::make_unique_for_overwrite<::google::protobuf::Empty>(), nullptr, 1, eNodeType::PlayerlocatorNodeService, playerlocator::SendPlayerLocatorSetLocation};
    ...
    gRpcServiceRegistry[PlayerLocatorMarkOfflineMessageId] = RpcService{"PlayerLocator", "MarkOffline", std::make_unique_for_overwrite<::playerlocator::PlayerId>(), std::make_unique_for_overwrite<::google::protobuf::Empty>(), nullptr, 1, eNodeType::PlayerlocatorNodeService, playerlocator::SendPlayerLocatorMarkOffline};
