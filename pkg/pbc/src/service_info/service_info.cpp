...
void InitMessageInfo()
{
    ...
    gMessageInfo[CentreServiceRegisterNodeSessionMessageId] = RpcService{"CentreService", "RegisterNodeSession", "::RegisterNodeSessionRequest", "::Empty", std::make_unique_for_overwrite<CentreServiceImpl>()};
    ...
    gMessageInfo[GameServiceRegisterNodeSessionMessageId] = RpcService{"GameService", "RegisterNodeSession", "::RegisterNodeSessionRequest", "::Empty", std::make_unique_for_overwrite<GameServiceImpl>()};
    ...
    gMessageInfo[GateServiceRegisterNodeSessionMessageId] = RpcService{"GateService", "RegisterNodeSession", "::RegisterNodeSessionRequest", "::Empty", std::make_unique_for_overwrite<GateServiceImpl>()};
