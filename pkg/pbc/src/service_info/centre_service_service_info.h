...
constexpr uint32_t CentreServiceGatePlayerServiceMessageId = 55;
...
constexpr uint32_t CentreServiceGateSessionDisconnectMessageId = 7;
...
constexpr uint32_t CentreServiceLoginNodeAccountLoginMessageId = 57;
...
constexpr uint32_t CentreServiceLoginNodeEnterGameMessageId = 71;
...
constexpr uint32_t CentreServiceLoginNodeLeaveGameMessageId = 80;
...
constexpr uint32_t CentreServiceLoginNodeSessionDisconnectMessageId = 67;
...
constexpr uint32_t CentreServicePlayerServiceMessageId = 15;
...
constexpr uint32_t CentreServiceEnterGsSucceedMessageId = 34;
...
constexpr uint32_t CentreServiceRouteNodeStringMsgMessageId = 5;
...
constexpr uint32_t CentreServiceRoutePlayerStringMsgMessageId = 64;
...
constexpr uint32_t CentreServiceInitSceneNodeMessageId = 49;
...
constexpr uint32_t CentreServiceRegisterNodeSessionMessageId = 40;
