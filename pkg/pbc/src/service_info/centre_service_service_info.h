...
constexpr uint32_t CentreServiceGatePlayerServiceMessageId = 54;
...
constexpr uint32_t CentreServiceGateSessionDisconnectMessageId = 58;
...
constexpr uint32_t CentreServiceLoginNodeAccountLoginMessageId = 46;
...
constexpr uint32_t CentreServiceLoginNodeEnterGameMessageId = 6;
...
constexpr uint32_t CentreServiceLoginNodeLeaveGameMessageId = 30;
...
constexpr uint32_t CentreServiceLoginNodeSessionDisconnectMessageId = 26;
...
constexpr uint32_t CentreServicePlayerServiceMessageId = 10;
...
constexpr uint32_t CentreServiceEnterGsSucceedMessageId = 14;
...
constexpr uint32_t CentreServiceRouteNodeStringMsgMessageId = 11;
...
constexpr uint32_t CentreServiceRoutePlayerStringMsgMessageId = 19;
...
constexpr uint32_t CentreServiceInitSceneNodeMessageId = 50;
...
constexpr uint32_t CentreServiceRegisterNodeSessionMessageId = 55;
