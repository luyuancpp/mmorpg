...
constexpr uint32_t AccountDBServiceLoad2RedisMessageId = 49;
...
constexpr uint32_t AccountDBServiceSave2RedisMessageId = 45;
...
constexpr uint32_t PlayerDBServiceLoad2RedisMessageId = 51;
...
constexpr uint32_t PlayerDBServiceSave2RedisMessageId = 76;
