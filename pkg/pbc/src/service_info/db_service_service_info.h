...
constexpr uint32_t AccountDBServiceLoad2RedisMessageId = 48;
...
constexpr uint32_t AccountDBServiceSave2RedisMessageId = 76;
...
constexpr uint32_t PlayerDBServiceLoad2RedisMessageId = 64;
...
constexpr uint32_t PlayerDBServiceSave2RedisMessageId = 73;
