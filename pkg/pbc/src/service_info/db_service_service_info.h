...
constexpr uint32_t AccountDBServiceLoad2RedisMessageId = 81;
...
constexpr uint32_t AccountDBServiceSave2RedisMessageId = 63;
...
constexpr uint32_t PlayerDBServiceLoad2RedisMessageId = 0;
...
constexpr uint32_t PlayerDBServiceSave2RedisMessageId = 80;
