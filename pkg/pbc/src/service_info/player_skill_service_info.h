...
constexpr uint32_t SceneSkillClientPlayerReleaseSkillMessageId = 12;
...
constexpr uint32_t SceneSkillClientPlayerNotifySkillInterruptedMessageId = 4;
...
constexpr uint32_t SceneSkillClientPlayerGetSkillListMessageId = 6;
