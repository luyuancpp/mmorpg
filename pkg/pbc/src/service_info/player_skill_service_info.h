...
constexpr uint32_t PlayerSkillServiceReleaseSkillMessageId = 11;
...
constexpr uint32_t PlayerSkillServiceNotifySkillUsedMessageId = 54;
...
constexpr uint32_t PlayerSkillServiceNotifySkillInterruptedMessageId = 1;
...
constexpr uint32_t PlayerSkillServiceGetSkillListMessageId = 2;
