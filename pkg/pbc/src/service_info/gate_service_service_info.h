...
constexpr uint32_t GateServicePlayerEnterGameNodeMessageId = 72;
...
constexpr uint32_t GateServiceSendMessageToPlayerMessageId = 27;
...
constexpr uint32_t GateServiceKickSessionByCentreMessageId = 60;
...
constexpr uint32_t GateServiceRouteNodeMessageMessageId = 69;
...
constexpr uint32_t GateServiceRoutePlayerMessageMessageId = 9;
...
constexpr uint32_t GateServiceBroadcastToPlayersMessageId = 36;
...
constexpr uint32_t GateServiceRegisterNodeSessionMessageId = 42;
