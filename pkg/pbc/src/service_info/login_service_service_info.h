...
constexpr uint32_t ClientPlayerLoginLoginMessageId = 81;
...
constexpr uint32_t ClientPlayerLoginCreatePlayerMessageId = 44;
...
constexpr uint32_t ClientPlayerLoginEnterGameMessageId = 45;
...
constexpr uint32_t ClientPlayerLoginLeaveGameMessageId = 77;
...
constexpr uint32_t ClientPlayerLoginDisconnectMessageId = 13;
