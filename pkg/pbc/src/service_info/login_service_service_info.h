...
constexpr uint32_t ClientPlayerLoginLoginMessageId = 74;
...
constexpr uint32_t ClientPlayerLoginCreatePlayerMessageId = 83;
...
constexpr uint32_t ClientPlayerLoginEnterGameMessageId = 48;
...
constexpr uint32_t ClientPlayerLoginLeaveGameMessageId = 62;
...
constexpr uint32_t ClientPlayerLoginDisconnectMessageId = 77;
