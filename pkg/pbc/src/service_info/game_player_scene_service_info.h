...
constexpr uint32_t GamePlayerSceneServiceEnterSceneMessageId = 61;
...
constexpr uint32_t GamePlayerSceneServiceLeaveSceneMessageId = 69;
...
constexpr uint32_t GamePlayerSceneServiceEnterSceneS2CMessageId = 24;
