...
constexpr uint32_t GamePlayerSceneServiceEnterSceneMessageId = 7;
...
constexpr uint32_t GamePlayerSceneServiceLeaveSceneMessageId = 16;
...
constexpr uint32_t GamePlayerSceneServiceEnterSceneS2CMessageId = 40;
