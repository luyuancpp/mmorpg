...
constexpr uint32_t SceneScenePlayerEnterSceneMessageId = 10;
...
constexpr uint32_t SceneScenePlayerLeaveSceneMessageId = 29;
...
constexpr uint32_t SceneScenePlayerEnterSceneS2CMessageId = 15;
