...
constexpr uint32_t CentrePlayerSceneServiceEnterSceneMessageId = 4;
...
constexpr uint32_t CentrePlayerSceneServiceLeaveSceneMessageId = 52;
...
constexpr uint32_t CentrePlayerSceneServiceLeaveSceneAsyncSavePlayerCompleteMessageId = 84;
...
constexpr uint32_t CentrePlayerSceneServiceSceneInfoC2SMessageId = 80;
