...
constexpr uint32_t EntitySyncServiceSyncBaseAttributeMessageId = 28;
...
constexpr uint32_t EntitySyncServiceSyncAttribute2FramesMessageId = 62;
...
constexpr uint32_t EntitySyncServiceSyncAttribute5FramesMessageId = 81;
...
constexpr uint32_t EntitySyncServiceSyncAttribute10FramesMessageId = 15;
...
constexpr uint32_t EntitySyncServiceSyncAttribute30FramesMessageId = 46;
...
constexpr uint32_t EntitySyncServiceSyncAttribute60FramesMessageId = 71;
