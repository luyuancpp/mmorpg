...
constexpr uint32_t EntitySyncServiceSyncBaseAttributeMessageId = 60;
...
constexpr uint32_t EntitySyncServiceSyncAttribute2FramesMessageId = 33;
...
constexpr uint32_t EntitySyncServiceSyncAttribute10FramesMessageId = 47;
...
constexpr uint32_t EntitySyncServiceSyncAttribute30FramesMessageId = 3;
...
constexpr uint32_t EntitySyncServiceSyncAttribute60FramesMessageId = 48;
