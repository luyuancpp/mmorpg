...
"data",
[](MissionPBComponent& pb) ->decltype(auto){ return pb.data();},
"mutable_data",
[](MissionPBComponent& pb) ->decltype(auto){ return pb.mutable_data();},
"DebugString",
...
"complete_missions",
[](MissionListPBComponent& pb) ->decltype(auto){ return pb.complete_missions();},
"mutable_complete_missions",
[](MissionListPBComponent& pb) ->decltype(auto){ return pb.mutable_complete_missions();},
