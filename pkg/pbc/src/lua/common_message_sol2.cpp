...
tls_lua_state.new_usertype<MessagePayload>("MessagePayload",
"body",
[](MessagePayload& pb) ->decltype(auto){ return pb.body();},
"mutable_body",
[](MessagePayload& pb) ->decltype(auto){ return pb.mutable_body();},
"message_id",
sol::property(&MessagePayload::message_id, &MessagePayload::set_message_id),
"id",
sol::property(&MessagePayload::id, &MessagePayload::set_id),
