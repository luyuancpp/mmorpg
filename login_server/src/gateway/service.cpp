    ...
    ::google::protobuf::Closure* done)
{
    ...
    GetSingletonLoginStub()->CallMethodString(this, &LoginServiceImpl::DbLoginReplied, cp,  &l2db::LoginService_Stub::Login);
}
    ...
    ::google::protobuf::Closure* done)
{
    ...
    GetSingletonLoginStub()->CallMethodString(this,
