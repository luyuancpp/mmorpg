...
// 	protoc        v5.26.1
// source: logic/component/time_meter_comp.proto
...
func (x *TimeMeterComp) Reset() {
	*x = TimeMeterComp{}
	if protoimpl.UnsafeEnabled {
		mi := &file_logic_component_time_meter_comp_proto_msgTypes[0]
...
func (*TimeMeterComp) Descriptor() ([]byte, []int) {
	return file_logic_component_time_meter_comp_proto_rawDescGZIP(), []int{0}
}
...
func (x *CooldownTimeComp) Reset() {
	*x = CooldownTimeComp{}
	if protoimpl.UnsafeEnabled {
		mi := &file_logic_component_time_meter_comp_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*CooldownTimeComp) Descriptor() ([]byte, []int) {
	return file_logic_component_time_meter_comp_proto_rawDescGZIP(), []int{1}
}

func (x *CooldownTimeComp) GetStart() uint32 {
	if x != nil {
		return x.Start
	}
	return 0
...
func (x *CooldownTimeListComp) Reset() {
	*x = CooldownTimeListComp{}
	if protoimpl.UnsafeEnabled {
		mi := &file_logic_component_time_meter_comp_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*CooldownTimeListComp) Descriptor() ([]byte, []int) {
	return file_logic_component_time_meter_comp_proto_rawDescGZIP(), []int{2}
}
...
var File_logic_component_time_meter_comp_proto protoreflect.FileDescriptor

var file_logic_component_time_meter_comp_proto_rawDesc = []byte{
	0x0a, 0x25, 0x6c, 0x6f, 0x67, 0x69, 0x63, 0x2f, 0x63, 0x6f, 0x6d, 0x70, 0x6f, 0x6e, 0x65, 0x6e,
	0x74, 0x2f, 0x74, 0x69, 0x6d, 0x65, 0x5f, 0x6d, 0x65, 0x74, 0x65, 0x72, 0x5f, 0x63, 0x6f, 0x6d,
...
var (
	file_logic_component_time_meter_comp_proto_rawDescOnce sync.Once
	file_logic_component_time_meter_comp_proto_rawDescData = file_logic_component_time_meter_comp_proto_rawDesc
)

func file_logic_component_time_meter_comp_proto_rawDescGZIP() []byte {
	file_logic_component_time_meter_comp_proto_rawDescOnce.Do(func() {
		file_logic_component_time_meter_comp_proto_rawDescData = protoimpl.X.CompressGZIP(file_logic_component_time_meter_comp_proto_rawDescData)
	})
	return file_logic_component_time_meter_comp_proto_rawDescData
}

var file_logic_component_time_meter_comp_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_logic_component_time_meter_comp_proto_goTypes = []any{
...
var file_logic_component_time_meter_comp_proto_depIdxs = []int32{
...
func init() { file_logic_component_time_meter_comp_proto_init() }
func file_logic_component_time_meter_comp_proto_init() {
	if File_logic_component_time_meter_comp_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_logic_component_time_meter_comp_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_logic_component_time_meter_comp_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_logic_component_time_meter_comp_proto_msgTypes[2].Exporter = func(v any, i int) any {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_logic_component_time_meter_comp_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_logic_component_time_meter_comp_proto_goTypes,
		DependencyIndexes: file_logic_component_time_meter_comp_proto_depIdxs,
		MessageInfos:      file_logic_component_time_meter_comp_proto_msgTypes,
	}.Build()
	File_logic_component_time_meter_comp_proto = out.File
	file_logic_component_time_meter_comp_proto_rawDesc = nil
	file_logic_component_time_meter_comp_proto_goTypes = nil
	file_logic_component_time_meter_comp_proto_depIdxs = nil
}
