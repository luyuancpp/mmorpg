...
// 	protoc        v4.25.1
// source: component_proto/mission_comp.proto
...
func (MissionPbCompEMissionStatus) Descriptor() protoreflect.EnumDescriptor {
	return file_component_proto_mission_comp_proto_enumTypes[0].Descriptor()
}

func (MissionPbCompEMissionStatus) Type() protoreflect.EnumType {
	return &file_component_proto_mission_comp_proto_enumTypes[0]
}
...
func (MissionPbCompEMissionStatus) EnumDescriptor() ([]byte, []int) {
	return file_component_proto_mission_comp_proto_rawDescGZIP(), []int{0, 0}
}
...
func (MissionsPbCompEMissionType) Descriptor() protoreflect.EnumDescriptor {
	return file_component_proto_mission_comp_proto_enumTypes[1].Descriptor()
}

func (MissionsPbCompEMissionType) Type() protoreflect.EnumType {
	return &file_component_proto_mission_comp_proto_enumTypes[1]
}
...
func (MissionsPbCompEMissionType) EnumDescriptor() ([]byte, []int) {
	return file_component_proto_mission_comp_proto_rawDescGZIP(), []int{1, 0}
}
...
func (x *MissionPbComp) Reset() {
	*x = MissionPbComp{}
	if protoimpl.UnsafeEnabled {
		mi := &file_component_proto_mission_comp_proto_msgTypes[0]
...
func (*MissionPbComp) Descriptor() ([]byte, []int) {
	return file_component_proto_mission_comp_proto_rawDescGZIP(), []int{0}
}
...
func (x *MissionsPbComp) Reset() {
	*x = MissionsPbComp{}
	if protoimpl.UnsafeEnabled {
		mi := &file_component_proto_mission_comp_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MissionsPbComp) Descriptor() ([]byte, []int) {
	return file_component_proto_mission_comp_proto_rawDescGZIP(), []int{1}
}
...
func (x *MissionRewardPbComp) Reset() {
	*x = MissionRewardPbComp{}
	if protoimpl.UnsafeEnabled {
		mi := &file_component_proto_mission_comp_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MissionRewardPbComp) Descriptor() ([]byte, []int) {
	return file_component_proto_mission_comp_proto_rawDescGZIP(), []int{2}
}
...
var File_component_proto_mission_comp_proto protoreflect.FileDescriptor

var file_component_proto_mission_comp_proto_rawDesc = []byte{
	0x0a, 0x22, 0x63, 0x6f, 0x6d, 0x70, 0x6f, 0x6e, 0x65, 0x6e, 0x74, 0x5f, 0x70, 0x72, 0x6f, 0x74,
	0x6f, 0x2f, 0x6d, 0x69, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x5f, 0x63, 0x6f, 0x6d, 0x70, 0x2e, 0x70,
...
var (
	file_component_proto_mission_comp_proto_rawDescOnce sync.Once
	file_component_proto_mission_comp_proto_rawDescData = file_component_proto_mission_comp_proto_rawDesc
)

func file_component_proto_mission_comp_proto_rawDescGZIP() []byte {
	file_component_proto_mission_comp_proto_rawDescOnce.Do(func() {
		file_component_proto_mission_comp_proto_rawDescData = protoimpl.X.CompressGZIP(file_component_proto_mission_comp_proto_rawDescData)
	})
	return file_component_proto_mission_comp_proto_rawDescData
}

var file_component_proto_mission_comp_proto_enumTypes = make([]protoimpl.EnumInfo, 2)
var file_component_proto_mission_comp_proto_msgTypes = make([]protoimpl.MessageInfo, 7)
var file_component_proto_mission_comp_proto_goTypes = []interface{}{
...
var file_component_proto_mission_comp_proto_depIdxs = []int32{
...
func init() { file_component_proto_mission_comp_proto_init() }
func file_component_proto_mission_comp_proto_init() {
	if File_component_proto_mission_comp_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_component_proto_mission_comp_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_component_proto_mission_comp_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_component_proto_mission_comp_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_component_proto_mission_comp_proto_rawDesc,
			NumEnums:      2,
			NumMessages:   7,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_component_proto_mission_comp_proto_goTypes,
		DependencyIndexes: file_component_proto_mission_comp_proto_depIdxs,
		EnumInfos:         file_component_proto_mission_comp_proto_enumTypes,
		MessageInfos:      file_component_proto_mission_comp_proto_msgTypes,
	}.Build()
	File_component_proto_mission_comp_proto = out.File
	file_component_proto_mission_comp_proto_rawDesc = nil
	file_component_proto_mission_comp_proto_goTypes = nil
	file_component_proto_mission_comp_proto_depIdxs = nil
}
