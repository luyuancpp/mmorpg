...
var file_logic_component_player_login_comp_proto_goTypes = []interface{}{
...
func file_logic_component_player_login_comp_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_logic_component_player_login_comp_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
