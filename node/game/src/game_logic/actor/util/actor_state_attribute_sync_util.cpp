...
void ActorStateAttributeSyncUtil::GetNearLevel1EntityList(entt::entity entity, const EntityVector& entityList)
{
}

void ActorStateAttributeSyncUtil::GetNearLevel2EntityList(entt::entity entity, const EntityVector& entityList)
{
}

void ActorStateAttributeSyncUtil::GetNearLevel3EntityList(entt::entity entity, const EntityVector& entityList)
{
}
