...
goctl rpc protoc ../proto/playerlocator/playerlocator.proto --proto_path=../ --proto_path=../third_party/grpc/third_party/protobuf/src/ --go_out=./playerlocator --go-grpc_out=./playerlocator --zrpc_out=./playerlocator -m
