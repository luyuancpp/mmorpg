...
goctl rpc protoc ../proto/player_locator/player_locator.proto --proto_path=../ --proto_path=../third_party/grpc/third_party/protobuf/src/ --go_out=./player_locator --go-grpc_out=./player_locator --zrpc_out=./playerlocator -m
