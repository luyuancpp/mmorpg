...
type BuffRow struct {
	...
	Immunetag      uint64 `protobuf:"varint,4,opt,name=immunetag,proto3" json:"immunetag,omitempty"`
...
func (x *BuffRow) GetImmunetag() uint64 {
	if x != nil {
		return x.Immunetag
	}
	return 0
...
var file_buff_config_proto_rawDesc = []byte{
	...
	0x74, 0x61, 0x67, 0x18, 0x03, 0x20, 0x01, 0x28, 0x04, 0x52, 0x03, 0x74, 0x61, 0x67, 0x12, 0x1c,
	0x0a, 0x09, 0x69, 0x6d, 0x6d, 0x75, 0x6e, 0x65, 0x74, 0x61, 0x67, 0x18, 0x04, 0x20, 0x01, 0x28,
	0x04, 0x52, 0x09, 0x69, 0x6d, 0x6d, 0x75, 0x6e, 0x65, 0x74, 0x61, 0x67, 0x12, 0x1a, 0x0a, 0x08,
