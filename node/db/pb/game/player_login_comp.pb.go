...
type EnterGameNodeInfoPBComp struct {
...
func (x *EnterGameNodeInfoPBComp) Reset() {
	*x = EnterGameNodeInfoPBComp{}
...
func (x *EnterGameNodeInfoPBComp) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*EnterGameNodeInfoPBComp) ProtoMessage() {}

func (x *EnterGameNodeInfoPBComp) ProtoReflect() protoreflect.Message {
	mi := &file_logic_component_player_login_comp_proto_msgTypes[0]
...
// Deprecated: Use EnterGameNodeInfoPBComp.ProtoReflect.Descriptor instead.
func (*EnterGameNodeInfoPBComp) Descriptor() ([]byte, []int) {
	return file_logic_component_player_login_comp_proto_rawDescGZIP(), []int{0}
}

func (x *EnterGameNodeInfoPBComp) GetEnterGsType() uint32 {
	if x != nil {
...
var file_logic_component_player_login_comp_proto_rawDesc = []byte{
	...
	0x6f, 0x6d, 0x70, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x3d, 0x0a, 0x17, 0x45, 0x6e, 0x74,
	0x65, 0x72, 0x47, 0x61, 0x6d, 0x65, 0x4e, 0x6f, 0x64, 0x65, 0x49, 0x6e, 0x66, 0x6f, 0x50, 0x42,
	0x43, 0x6f, 0x6d, 0x70, 0x12, 0x22, 0x0a, 0x0d, 0x65, 0x6e, 0x74, 0x65, 0x72, 0x5f, 0x67, 0x73,
	0x5f, 0x74, 0x79, 0x70, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x0b, 0x65, 0x6e, 0x74,
	0x65, 0x72, 0x47, 0x73, 0x54, 0x79, 0x70, 0x65, 0x2a, 0x56, 0x0a, 0x0b, 0x45, 0x6e, 0x74, 0x65,
	...
	0x4e, 0x5f, 0x52, 0x45, 0x50, 0x4c, 0x41, 0x43, 0x45, 0x10, 0x02, 0x12, 0x13, 0x0a, 0x0f, 0x4c,
	0x4f, 0x47, 0x49, 0x4e, 0x5f, 0x52, 0x45, 0x43, 0x4f, 0x4e, 0x4e, 0x45, 0x43, 0x54, 0x10, 0x03,
...
var file_logic_component_player_login_comp_proto_goTypes = []any{
	...
	(*EnterGameNodeInfoPBComp)(nil), // 1: EnterGameNodeInfoPBComp
}
...
func file_logic_component_player_login_comp_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_logic_component_player_login_comp_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*EnterGameNodeInfoPBComp); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
