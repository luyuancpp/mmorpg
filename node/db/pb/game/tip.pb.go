...
var file_common_tip_proto_rawDesc = []byte{
	...
	0x74, 0x6f, 0x22, 0x2b, 0x0a, 0x03, 0x54, 0x69, 0x70, 0x12, 0x0e, 0x0a, 0x02, 0x69, 0x64, 0x18,
	0x01, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x02, 0x69, 0x64, 0x12, 0x14, 0x0a, 0x05, 0x70, 0x61, 0x72,
	0x61, 0x6d, 0x18, 0x02, 0x20, 0x03, 0x28, 0x09, 0x52, 0x05, 0x70, 0x61, 0x72, 0x61, 0x6d, 0x42,
...
var file_common_tip_proto_goTypes = []interface{}{
	(*Tip)(nil), // 0: Tip
}
...
func file_common_tip_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_common_tip_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Tip); i {
			case 0:
				return &v.state
			case 1:
