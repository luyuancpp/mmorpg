...
func (x *LoadPlayerCentreRequest) Reset() {
	*x = LoadPlayerCentreRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_common_proto_db_service_proto_msgTypes[8]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*LoadPlayerCentreRequest) Descriptor() ([]byte, []int) {
	return file_common_proto_db_service_proto_rawDescGZIP(), []int{8}
}
...
func (x *LoadPlayerCentreResponse) Reset() {
	*x = LoadPlayerCentreResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_common_proto_db_service_proto_msgTypes[9]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*LoadPlayerCentreResponse) Descriptor() ([]byte, []int) {
	return file_common_proto_db_service_proto_rawDescGZIP(), []int{9}
}
...
func (x *SavePlayerCentreRequest) Reset() {
	*x = SavePlayerCentreRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_common_proto_db_service_proto_msgTypes[10]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*SavePlayerCentreRequest) Descriptor() ([]byte, []int) {
	return file_common_proto_db_service_proto_rawDescGZIP(), []int{10}
}
...
func (x *SavePlayerCentreResponse) Reset() {
	*x = SavePlayerCentreResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_common_proto_db_service_proto_msgTypes[11]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*SavePlayerCentreResponse) Descriptor() ([]byte, []int) {
	return file_common_proto_db_service_proto_rawDescGZIP(), []int{11}
}
...
var file_common_proto_db_service_proto_rawDesc = []byte{
	...
	,
...
var file_common_proto_db_service_proto_msgTypes = make([]protoimpl.MessageInfo, 12)
...
var file_common_proto_db_service_proto_depIdxs = []int32{
	...
	8,  // 4: PlayerCentreDBService.Load2Redis:input_type -> LoadPlayerCentreRequest
	10, // 5: PlayerCentreDBService.Save2Redis:input_type -> SavePlayerCentreRequest
	1,  // 6: AccountDBService.Load2Redis:output_type -> LoadAccountResponse
	3,  // 7: AccountDBService.Save2Redis:output_type -> SaveAccountResponse
	5,  // 8: PlayerDBService.Load2Redis:output_type -> LoadPlayerResponse
	7,  // 9: PlayerDBService.Save2Redis:output_type -> SavePlayerResponse
	9,  // 10: PlayerCentreDBService.Load2Redis:output_type -> LoadPlayerCentreResponse
	11, // 11: PlayerCentreDBService.Save2Redis:output_type -> SavePlayerCentreResponse
...
func file_common_proto_db_service_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_common_proto_db_service_proto_msgTypes[8].Exporter = func(v interface{}, i int) interface{} {
		...
		file_common_proto_db_service_proto_msgTypes[9].Exporter = func(v interface{}, i int) interface{} {
		...
		file_common_proto_db_service_proto_msgTypes[10].Exporter = func(v interface{}, i int) interface{} {
		...
		file_common_proto_db_service_proto_msgTypes[11].Exporter = func(v interface{}, i int) interface{} {
