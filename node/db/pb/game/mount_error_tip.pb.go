...
const (
	...
	MountError_kMountNotMounted MountError = 101
)
...
var (
	MountError_name = map[int32]string{
		0:   "kMount_errorOK",
		101: "kMountNotMounted",
	}
	MountError_value = map[string]int32{
		"kMount_errorOK":   0,
		"kMountNotMounted": 101,
	}
)
...
var file_mount_error_tip_proto_rawDesc = []byte{
	...
	0x6f, 0x75, 0x6e, 0x74, 0x4e, 0x6f, 0x74, 0x4d, 0x6f, 0x75, 0x6e, 0x74, 0x65, 0x64, 0x10, 0x65,
