...
// 	protoc        v4.25.1
// source: component_proto/player_scene_comp.proto
...
func (x *PlayerSceneInfo) Reset() {
	*x = PlayerSceneInfo{}
	if protoimpl.UnsafeEnabled {
		mi := &file_component_proto_player_scene_comp_proto_msgTypes[0]
...
func (*PlayerSceneInfo) Descriptor() ([]byte, []int) {
	return file_component_proto_player_scene_comp_proto_rawDescGZIP(), []int{0}
}
...
func (x *PlayerSceneInfoComp) Reset() {
	*x = PlayerSceneInfoComp{}
	if protoimpl.UnsafeEnabled {
		mi := &file_component_proto_player_scene_comp_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*PlayerSceneInfoComp) Descriptor() ([]byte, []int) {
	return file_component_proto_player_scene_comp_proto_rawDescGZIP(), []int{1}
}
...
var File_component_proto_player_scene_comp_proto protoreflect.FileDescriptor

var file_component_proto_player_scene_comp_proto_rawDesc = []byte{
	0x0a, 0x27, 0x63, 0x6f, 0x6d, 0x70, 0x6f, 0x6e, 0x65, 0x6e, 0x74, 0x5f, 0x70, 0x72, 0x6f, 0x74,
	0x6f, 0x2f, 0x70, 0x6c, 0x61, 0x79, 0x65, 0x72, 0x5f, 0x73, 0x63, 0x65, 0x6e, 0x65, 0x5f, 0x63,
...
var (
	file_component_proto_player_scene_comp_proto_rawDescOnce sync.Once
	file_component_proto_player_scene_comp_proto_rawDescData = file_component_proto_player_scene_comp_proto_rawDesc
)

func file_component_proto_player_scene_comp_proto_rawDescGZIP() []byte {
	file_component_proto_player_scene_comp_proto_rawDescOnce.Do(func() {
		file_component_proto_player_scene_comp_proto_rawDescData = protoimpl.X.CompressGZIP(file_component_proto_player_scene_comp_proto_rawDescData)
	})
	return file_component_proto_player_scene_comp_proto_rawDescData
}

var file_component_proto_player_scene_comp_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_component_proto_player_scene_comp_proto_goTypes = []interface{}{
	(*PlayerSceneInfo)(nil),     // 0: PlayerSceneInfo
	(*PlayerSceneInfoComp)(nil), // 1: PlayerSceneInfoComp
}
var file_component_proto_player_scene_comp_proto_depIdxs = []int32{
...
func init() { file_component_proto_player_scene_comp_proto_init() }
func file_component_proto_player_scene_comp_proto_init() {
	if File_component_proto_player_scene_comp_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_component_proto_player_scene_comp_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_component_proto_player_scene_comp_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_component_proto_player_scene_comp_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_component_proto_player_scene_comp_proto_goTypes,
		DependencyIndexes: file_component_proto_player_scene_comp_proto_depIdxs,
		MessageInfos:      file_component_proto_player_scene_comp_proto_msgTypes,
	}.Build()
	File_component_proto_player_scene_comp_proto = out.File
	file_component_proto_player_scene_comp_proto_rawDesc = nil
	file_component_proto_player_scene_comp_proto_goTypes = nil
	file_component_proto_player_scene_comp_proto_depIdxs = nil
}
