...
| Tag          | Value | Source |
|-------------|-------|--------|
| `kNormal`   | 0 | Default spatial grid discovery |
...
| `kPinned`   | 5 | Buff/skill explicit pin (always max weight 255) |
...
- **Lazy-time / hysteresis**: Add a grace period before removing entities
